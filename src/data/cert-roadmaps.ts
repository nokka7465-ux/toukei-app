...
export const certRoadmaps: Record<string, CertRoadmap> = {
  ...
  "azure-az-305": {
    slug: "azure-az-305",
    title: "Azure AZ-305 学習ロードマップ",
    organizer: "Microsoft",
    hours: "100〜200 時間",
    months: "2〜4 ヶ月",
    prerequisites: "AZ-104 合格 + Azure 実務経験 1-2 年以上",
    passCriteria: "1000 点満点中 700 点",
    steps: [
      { week: "Week 1〜2", title: "Identity / Governance / Monitor", description: "Entra ID / Conditional Access / PIM / Policy / Management Group / Azure Monitor / Sentinel。", links: [{ href: "/certs/azure-az-305/textbook", label: "AZ-305 教科書(章 1-2)" }] },
      { week: "Week 3〜4", title: "Compute / Storage / Database", description: "VM / AKS / App Service / Functions ・ Blob / Files / NetApp ・ SQL DB / Cosmos DB / PostgreSQL。", links: [{ href: "/certs/azure-az-305/textbook", label: "AZ-305 教科書(章 3-4)" }] },
      { week: "Week 5〜6", title: "Network / Hybrid / Security", description: "VNet / Peering / VPN / ExpressRoute / Hub-Spoke ・ Defender for Cloud / Sentinel / Key Vault / Encryption。", links: [{ href: "/certs/azure-az-305/textbook", label: "AZ-305 教科書(章 5-6)" }] },
      { week: "Week 7〜8", title: "BCP / Migration / WAF / CAF", description: "RPO / RTO / Backup / ASR / Multi-Region ・ Azure Migrate / 7 R's ・ Well-Architected Framework / Cloud Adoption Framework。", links: [{ href: "/certs/azure-az-305/textbook", label: "AZ-305 教科書(章 7-8)" }] },
      { week: "Week 9〜10", title: "ケーススタディ + 模擬試験", description: "Azure Architecture Center の Reference Architecture を読み、本サイト演習問題で反復。", links: [{ href: "/certs/azure-az-305/quiz", label: "AZ-305 演習問題" }, { href: "/practice", label: "ランダム練習" }] },
    ],
    textbookHref: "/certs/azure-az-305/textbook",
    quizHref: "/certs/azure-az-305/quiz",
  },
  "sc-100": {
    slug: "sc-100",
    title: "Microsoft SC-100 学習ロードマップ",
    organizer: "Microsoft",
    hours: "100〜200 時間",
    months: "2〜4 ヶ月",
    prerequisites: "AZ-500 / SC-200 / SC-300 等のセキュリティ Associate + Architect 実務",
    passCriteria: "1000 点満点中 700 点",
    steps: [
      { week: "Week 1〜2", title: "Zero Trust + MCRA", description: "Zero Trust 3 原則 + 6 Pillars + MCRA / NIST CSF 2.0 / MITRE ATT&CK。", links: [{ href: "/certs/sc-100/textbook", label: "SC-100 教科書(章 1)" }] },
      { week: "Week 3〜4", title: "Identity + Defender XDR + Sentinel", description: "Entra ID / Conditional Access / PIM ・ Defender XDR / Sentinel(SIEM+SOAR) ・ Copilot for Security。", links: [{ href: "/certs/sc-100/textbook", label: "SC-100 教科書(章 2-3)" }] },
      { week: "Week 5〜6", title: "Defender for Cloud + CNAPP + Purview", description: "CSPM / CWPP / CIEM / Attack Path ・ Purview(DLP / Insider / Compliance Manager)・ AI Security(OWASP LLM Top 10)。", links: [{ href: "/certs/sc-100/textbook", label: "SC-100 教科書(章 4-5)" }] },
      { week: "Week 7〜8", title: "Network / SASE / DevSecOps / Resilience", description: "Microsegmentation / Global Secure Access(SASE)・ Container Security / Shift Left ・ Ransomware 対策 / STRIDE / Kill Chain。", links: [{ href: "/certs/sc-100/textbook", label: "SC-100 教科書(章 6)" }] },
      { week: "Week 9〜10", title: "ケーススタディ + 模擬試験", description: "Zero Trust 移行 / Ransomware / Insider Threat / Compliance / M&A / Cloud Migration / DevSecOps の典型シナリオ反復。", links: [{ href: "/certs/sc-100/quiz", label: "SC-100 演習問題" }, { href: "/practice", label: "ランダム練習" }] },
    ],
    textbookHref: "/certs/sc-100/textbook",
    quizHref: "/certs/sc-100/quiz",
  },
  "tableau-data-analyst": {
    slug: "tableau-data-analyst",
    title: "Tableau Data Analyst 学習ロードマップ",
    organizer: "Salesforce / Tableau",
    hours: "60〜120 時間",
    months: "2〜3 ヶ月",
    prerequisites: "Tableau Specialist 取得 or 実務 3-6 ヶ月",
    passCriteria: "1000 点満点中 750 点",
    steps: [
      { week: "Week 1", title: "Connect / Prep + Specialist 範囲復習", description: "Live / Extract / Relationships / Cross-DB Join + Tableau Prep の Step Type。", links: [{ href: "/certs/tableau-data-analyst/textbook", label: "DA 教科書(章 1-2)" }] },
      { week: "Week 2〜3", title: "Calculation(LOD / Table Calc)", description: "LOD 3 種 ・ Table Calc / Window Function ・ Logical / Date / String / Aggregation 関数。", links: [{ href: "/certs/tableau-data-analyst/textbook", label: "DA 教科書(章 3)" }] },
      { week: "Week 4〜5", title: "Dashboard / Story / Visualization", description: "Filter / Parameter / Set Action ・ Container / Action / Annotation ・ Reference Line / Box Plot。", links: [{ href: "/certs/tableau-data-analyst/textbook", label: "DA 教科書(章 4)" }] },
      { week: "Week 6〜7", title: "Server / Cloud / Security", description: "Site Role / Permission / RLS / OLS / Connected Apps / Subscription / Bridge / Schedule。", links: [{ href: "/certs/tableau-data-analyst/textbook", label: "DA 教科書(章 5)" }] },
      { week: "Week 8", title: "Performance + AI + Performance Task", description: "Performance Recorder / Pulse / Einstein Copilot ・ ハンズオン Performance Task 練習(Tableau Public で実機)。", links: [{ href: "/certs/tableau-data-analyst/quiz", label: "DA 演習問題" }, { href: "/practice", label: "ランダム練習" }] },
    ],
    textbookHref: "/certs/tableau-data-analyst/textbook",
    quizHref: "/certs/tableau-data-analyst/quiz",
  },
  "snowflake-dea": {
    slug: "snowflake-dea",
    title: "SnowPro DEA 学習ロードマップ",
    organizer: "Snowflake",
    hours: "80〜150 時間",
    months: "2〜3 ヶ月",
    prerequisites: "SnowPro Core 取得 + Snowflake 実務 1-2 年",
    passCriteria: "1000 点満点中 750 点",
    steps: [
      { week: "Week 1", title: "Architecture 復習 + Editions", description: "3 層アーキテクチャ ・ Edition(Standard / Enterprise / Business Critical / VPS)・ Multi-Cluster WH ・ Scaling Policy。", links: [{ href: "/certs/snowflake-dea/textbook", label: "DEA 教科書(章 1)" }] },
      { week: "Week 2〜3", title: "Data Movement(Snowpipe / Streams / Tasks)", description: "Bulk Load / Snowpipe(Auto-Ingest)/ Snowpipe Streaming / Streams + Tasks 増分 ELT。", links: [{ href: "/certs/snowflake-dea/textbook", label: "DEA 教科書(章 2)" }] },
      { week: "Week 4〜5", title: "Snowpark + Stored Procedure + Cortex AI", description: "Snowpark Python / Container Services ・ Stored Procedure(SQL Scripting / Python)・ Cortex AI Functions / Search / Analyst。", links: [{ href: "/certs/snowflake-dea/textbook", label: "DEA 教科書(章 3)" }] },
      { week: "Week 6", title: "Performance + Cost", description: "Clustering / SOS / Materialized View / Query Profile / Cache 3 階層 / Spilling。", links: [{ href: "/certs/snowflake-dea/textbook", label: "DEA 教科書(章 4)" }] },
      { week: "Week 7", title: "Iceberg + Polaris + Native Apps + Sharing", description: "Iceberg Tables / Apache Polaris / Native App Framework / Marketplace / Streamlit in Snowflake。", links: [{ href: "/certs/snowflake-dea/textbook", label: "DEA 教科書(章 5)" }] },
      { week: "Week 8", title: "Storage Protection + Security + 模擬試験", description: "Time Travel / Fail-Safe / Replication / DDM / RAP / Tag / RBAC / Horizon Catalog ・ 演習問題反復。", links: [{ href: "/certs/snowflake-dea/quiz", label: "DEA 演習問題" }, { href: "/practice", label: "ランダム練習" }] },
    ],
    textbookHref: "/certs/snowflake-dea/textbook",
    quizHref: "/certs/snowflake-dea/quiz",
  },
  "databricks-ml-engineer": {
    slug: "databricks-ml-engineer",
    title: "Databricks ML Engineer 学習ロードマップ",
    organizer: "Databricks",
    hours: "80〜150 時間",
    months: "2〜3 ヶ月",
    prerequisites: "ML Associate 取得 + Databricks 実務 6 ヶ月-1 年",
    passCriteria: "70-75% 合格",
    steps: [
      { week: "Week 1", title: "DBR ML + Skills 5 領域", description: "Databricks Runtime for ML / Topic Area / ML Associate 復習。", links: [{ href: "/certs/databricks-ml-engineer/textbook", label: "ML Engineer 教科書(章 1)" }] },
      { week: "Week 2〜3", title: "MLflow + Feature Store + Registry", description: "MLflow 4 モジュール + Autolog ・ Unity Catalog Model Registry(Aliases / Lineage)・ Feature Store + Point-in-Time Join。", links: [{ href: "/certs/databricks-ml-engineer/textbook", label: "ML Engineer 教科書(章 2)" }] },
      { week: "Week 4", title: "AutoML + Hyperopt + Distributed", description: "Databricks AutoML / Hyperopt + SparkTrials / TorchDistributor / DeepSpeed / Ray on Databricks。", links: [{ href: "/certs/databricks-ml-engineer/textbook", label: "ML Engineer 教科書(章 3)" }] },
      { week: "Week 5", title: "Model Serving + Lakehouse Monitoring", description: "Model Serving(A/B Routing / Inference Tables / Mosaic AI Gateway)・ Lakehouse Monitoring(Time Series / Snapshot / Inference Profile)。", links: [{ href: "/certs/databricks-ml-engineer/textbook", label: "ML Engineer 教科書(章 4)" }] },
      { week: "Week 6〜7", title: "Mosaic AI(GenAI)", description: "Vector Search + Foundation Model API + Agent Framework + DBRX + AI Functions + Genie + Agent Evaluation。", links: [{ href: "/certs/databricks-ml-engineer/textbook", label: "ML Engineer 教科書(章 5)" }] },
      { week: "Week 8", title: "MLOps Asset Bundle + 模擬試験", description: "DAB(YAML IaC)・ MLOps Stacks / Cluster Policy / Cost ・ Sample Notebooks 反復。", links: [{ href: "/certs/databricks-ml-engineer/quiz", label: "ML Engineer 演習問題" }, { href: "/practice", label: "ランダム練習" }] },
    ],
    textbookHref: "/certs/databricks-ml-engineer/textbook",
    quizHref: "/certs/databricks-ml-engineer/quiz",
  },
  "gcp-devops-engineer": {
    slug: "gcp-devops-engineer",
    title: "GCP Pro DevOps Engineer 学習ロードマップ",
    organizer: "Google Cloud",
    hours: "150〜250 時間",
    months: "3〜4 ヶ月",
    prerequisites: "GCP 実務 3 年 + DevOps 実務 1 年(推奨)",
    passCriteria: "非公開(70% 程度推定)",
    steps: [
      { week: "Week 1〜2", title: "SRE 原則 + Google SRE Book", description: "5 原則 ・ SLI/SLO/Error Budget ・ Toil ・ Blameless Postmortem ・ 4 Golden Signals。", links: [{ href: "/certs/gcp-devops-engineer/textbook", label: "Pro DevOps 教科書(章 1-2)" }] },
      { week: "Week 3〜4", title: "Observability(Monitoring / Logging / Trace / Profiler / OTel)", description: "3 Pillars + Profile ・ OpenTelemetry ・ Logs-based Metrics ・ Custom Metrics。", links: [{ href: "/certs/gcp-devops-engineer/textbook", label: "Pro DevOps 教科書(章 3)" }] },
      { week: "Week 5〜6", title: "CI/CD(Build / Deploy / Artifact / Binary Auth)", description: "Cloud Build / Cloud Deploy(Canary/Blue-Green)/ Artifact Registry / Binary Authorization / Cosign-Sigstore / SLSA。", links: [{ href: "/certs/gcp-devops-engineer/textbook", label: "Pro DevOps 教科書(章 4)" }] },
      { week: "Week 7〜8", title: "Compute / IaC / Incident", description: "GKE Autopilot / Cloud Run / Anthos ・ Terraform / Config Connector / Workload Identity ・ Incident Response 役割。", links: [{ href: "/certs/gcp-devops-engineer/textbook", label: "Pro DevOps 教科書(章 5)" }] },
      { week: "Week 9〜10", title: "Network / Security / DataOps / Cost / 模擬試験", description: "Cloud Armor / IAP / VPC-SC ・ Cloud SQL HA / Spanner Multi-Region ・ DataOps + dbt + Airflow ・ CUD / Spot ・ 演習問題反復。", links: [{ href: "/certs/gcp-devops-engineer/quiz", label: "Pro DevOps 演習問題" }, { href: "/practice", label: "ランダム練習" }] },
    ],
    textbookHref: "/certs/gcp-devops-engineer/textbook",
    quizHref: "/certs/gcp-devops-engineer/quiz",
  },
  "gcp-data-engineer": {
