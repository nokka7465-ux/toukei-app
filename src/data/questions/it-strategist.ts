...
export const itStrategistQuestions: Question[] = [
  ...
  { id: "st-q66", category: "経営戦略", difficulty: 4, question: "**Ansoff Matrix** の 4 つの成長戦略として **誤っているもの** を選びなさい。", choices: ["市場浸透", "市場開拓", "製品開発 / 多角化", "GPU 強化"], correctIndex: 3, explanation: "**Ansoff**: 既存 / 新規 × 製品 / 市場 → 4 マス。**市場浸透 / 市場開拓 / 製品開発 / 多角化**。**多角化はリスク高 ・ シナジー検討必須**。BCG / GE マトリクスと組合せで戦略決定。" },
  { id: "st-q67", category: "経営戦略", difficulty: 4, question: "**コアコンピタンス** の 3 条件として **誤っているもの** を選びなさい。", choices: ["顧客価値への貢献", "競合との差別化", "他分野への展開可能性", "GPU 数"], correctIndex: 3, explanation: "**Core Competence**(Prahalad & Hamel): ① 顧客価値貢献 ② 競合との明確な差別化 ③ 多市場展開可能性。**ハードに見えにくく ・ 模倣困難**な経営資源。" },
  { id: "st-q68", category: "DX 戦略", difficulty: 4, question: "**DX レポート 2.0**(経産省 2020)で示された **コロナ禍以降** のキーワードとして最も適切なものを選びなさい。", choices: ["デジタル産業 / レガシー脱却 / 業界変革(Industrial Transformation)", "全社員 GPU 配布", "コーディング教育のみ", "オフィス回帰"], correctIndex: 0, explanation: "**DX レポート 2 ・ 2.1**: コロナで顕在化した課題 ・ デジタル変革の加速 ・ DX 推進指標 ・ 共通プラットフォーム化。**Industrial Transformation**(業界横断変革)が重要キーワード。" },
  { id: "st-q69", category: "AI 戦略", difficulty: 4, question: "**Responsible AI** で **AI 開発 / 提供 / 利用** 3 主体ごとの典型責任として **誤っているもの** を選びなさい。", choices: ["開発: 透明性 ・ 公平性 ・ 安全性確保", "提供: ガイドライン ・ ユーザー教育", "利用: 適切利用 ・ 倫理判断", "GPU 性能最大化"], correctIndex: 3, explanation: "**AI 事業者ガイドライン**(2024 統合): 開発 / 提供 / 利用の 3 主体別に **責任分担**。**広島 AI プロセス** とも整合。GPU 性能は技術指標で経営課題ではない。" },
  { id: "st-q70", category: "IT 投資", difficulty: 4, question: "**IT 投資ポートフォリオ** の典型分類として **誤っているもの** を選びなさい。", choices: ["戦略型 / 情報型 / トランザクション型 / インフラ型", "売上 / 利益 / 資産", "Run / Grow / Transform", "GPU / CPU"], correctIndex: 3, explanation: "**IT 投資**(Weill & Aral): ① 戦略型(競争優位)② 情報型(意思決定支援)③ Tx 型(業務効率)④ インフラ型(基盤)。**Run / Grow / Transform**(運用 / 改善 / 変革)分類も。" },
  { id: "st-q71", category: "DX 戦略", difficulty: 4, question: "**Two-Speed IT** の意味として最も適切なものを選びなさい。", choices: ["既存 SoR(安定 ・ 低速)と新規 SoE(俊敏 ・ 高速)を並立", "GPU vs CPU", "オン vs オフ", "AI vs Human"], correctIndex: 0, explanation: "**Two-Speed IT**: SoR(System of Record、基幹系 ・ 安定)+ SoE(System of Engagement、顧客系 ・ 俊敏)。**Bimodal IT**(Gartner)と同義。**Mode 1 / Mode 2**。レガシー × 新規両立の DX 戦略。" },
  { id: "st-q72", category: "Data 戦略", difficulty: 4, question: "**Data Governance** の主要 3 要素として最も適切なものを選びなさい。", choices: ["品質 / セキュリティ ・ プライバシ / アクセス管理", "GPU / CPU / メモリ", "営業 / 開発 / 経理", "Cloud / On-prem / Hybrid"], correctIndex: 0, explanation: "**Data Governance**(DAMA-DMBOK): 品質 / プライバシ ・ セキュリティ / アクセス ・ Steward 制 / Lineage / カタログ / マスターデータ管理。**CDO 主導**で全社展開。" },
  { id: "st-q73", category: "リーダーシップ", difficulty: 4, question: "**サーバントリーダーシップ** の特徴として最も適切なものを選びなさい。", choices: ["メンバーに奉仕 ・ 支援することで成果を引き出すスタイル", "命令型のみ", "管理型のみ", "個人主義"], correctIndex: 0, explanation: "**Servant Leadership**(Greenleaf): 部下の成長 ・ 自律性支援 → 組織パフォーマンス向上。**サーベイ ・ 心理的安全性 ・ コーチング** と親和性高。DX 推進に適合。" },
  { id: "st-q74", category: "Innovation", difficulty: 4, question: "**Open Innovation**(Chesbrough)の意味として最も適切なものを選びなさい。", choices: ["社内外の知識 ・ 技術を組合せ革新加速(M&A / アライアンス / OSS)", "社内 R&D のみ", "GUI 設計", "認証"], correctIndex: 0, explanation: "**Open Innovation**(2003 提唱): クローズ R&D の限界 → **ベンチャー投資 / M&A / OSS / 大学連携 / アクセラレータ**。**Outside-In + Inside-Out** の両方向。" },
  { id: "st-q75", category: "Compliance", difficulty: 4, question: "**個情法 ・ GDPR ・ CCPA** に共通する原則として **誤っているもの** を選びなさい。", choices: ["利用目的の明示 ・ 同意", "本人開示 ・ 訂正 ・ 削除権", "越境移転規制", "全社員 GPU 配布"], correctIndex: 3, explanation: "**個人情報保護 3 大法**: 個情法(日)/ GDPR(EU)/ CCPA(カリフォルニア)。**共通**: 目的明示 / 同意 / 本人権利 / 越境規制 / 違反通知 / 罰則。GPU 配布は無関係。" },
  { id: "st-q76", category: "技術戦略", difficulty: 4, question: "**Buy vs Build vs Partner** の判断基準として **誤っているもの** を選びなさい。", choices: ["コア競争力 → Build", "汎用機能 → Buy(SaaS)", "中間領域 → Partner", "GPU 数で決定"], correctIndex: 3, explanation: "**Make-or-Buy**: 戦略的価値 ・ 内製能力 ・ Time-to-Market ・ TCO で判断。**コアは Build / 汎用は Buy / 中間は Partner / Co-source**。GPU 数は判断要因ではない。" },
  { id: "st-q77", category: "PMO", difficulty: 4, question: "**PMO**(Project Management Office)の主機能として **誤っているもの** を選びなさい。", choices: ["プロジェクト標準化 / メトリクス収集", "リソース管理 / 教育 / コンサル", "ポートフォリオ管理", "GPU 提供"], correctIndex: 3, explanation: "**PMO**: 支援型(コンサル)・ 統制型(標準遵守)・ 指揮型(直接管理)。**ポートフォリオ管理(PfMO)・ プログラム管理(PgMO)・ プロジェクト管理(PMO)** の階層。" },
  { id: "st-q78", category: "EA", difficulty: 4, question: "**TOGAF ADM**(Architecture Development Method)の 8 フェーズとして **誤っているもの** を選びなさい。", choices: ["Preliminary / Vision", "Business / Information / Tech Architecture", "Opportunities / Migration / Governance", "GPU Tuning"], correctIndex: 3, explanation: "**TOGAF ADM**: Preliminary → Vision → BA → IA → TA → Opportunities → Migration → Implementation → Governance → Change Management。**Enterprise Architecture 標準 FW**。" },
  { id: "st-q79", category: "Cybersecurity", difficulty: 4, question: "**NIST Cybersecurity Framework** の 5 つの機能として **誤っているもの** を選びなさい。", choices: ["Identify / Protect", "Detect / Respond", "Recover", "GPU"], correctIndex: 3, explanation: "**NIST CSF**: ① Identify(資産 ・ リスク把握)② Protect(防御策)③ Detect(検知)④ Respond(対応)⑤ Recover(復旧)。**Govern**(2024 CSF 2.0 で追加)。CISO 戦略の中核。" },
  { id: "st-q80", category: "実務", difficulty: 4, question: "IT ストラテジストで重視される **総合経営 × IT 戦略力** として最も適切なものを選びなさい。", choices: ["経営戦略 + 業務改革 + IT 戦略 + 投資判断 + ガバナンス + リスク + 推進体制の統合", "技術のみ", "GUI のみ", "コスト最優先"], correctIndex: 0, explanation: "**ITストラテジスト 4 領域**: ① 事業戦略 ・ IT 戦略立案 ② 業務改革 ・ プロセス再設計 ③ 情報システム化計画 ④ 個別 IT 投資 ・ 推進。**経営者視点で IT を活用**する高度試験。" },
];
