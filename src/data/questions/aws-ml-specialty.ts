...
export const awsMlSpecialtyQuestions: Question[] = [
  ...
  { id: "mls-q66", category: "Data", difficulty: 3, question: "**SageMaker Ground Truth** の用途として最も適切なものを選びなさい。", choices: ["ラベリングサービス(人間 + Active Learning 自動化)", "学習データ生成", "GPU 監視", "認証"], correctIndex: 0, explanation: "**Ground Truth**: ラベリングジョブ。**Active Learning**(難サンプルのみ人間 ・ 易サンプルは Auto-Label)で コスト削減。**Mechanical Turk / Vendor / Private Workforce**選択可。" },
  { id: "mls-q67", category: "Algorithm", difficulty: 3, question: "**SageMaker XGBoost** の特徴として最も適切なものを選びなさい。", choices: ["分散学習対応 + CSV / Parquet 入力 + Tabular で標準選択肢", "画像専用", "GPU 不可", "認証"], correctIndex: 0, explanation: "**SageMaker XGBoost**: マネージドコンテナで分散学習 + Spot 対応 + Auto Tuning。**Tabular の業界標準**。**LightGBM / CatBoost**(Custom Container)も選択可。" },
  { id: "mls-q68", category: "Inference", difficulty: 3, question: "**SageMaker Inference Recommender** の用途として最も適切なものを選びなさい。", choices: ["モデル + Endpoint Type / Instance のベンチマーク → 最適構成提案", "学習用", "GUI", "認証"], correctIndex: 0, explanation: "**Inference Recommender**: モデル + サンプルデータで複数 Endpoint 構成(CPU/GPU/Inferentia)をベンチマーク → **コスト ・ レイテンシ ・ スループット** トレードオフを可視化。" },
  { id: "mls-q69", category: "Cost", difficulty: 3, question: "**SageMaker Serverless Inference** の最大メモリ容量(2024 時点)として最も近いものを選びなさい。", choices: ["6 GB", "1 GB", "32 GB", "128 GB"], correctIndex: 0, explanation: "**Serverless Inference**: Memory 1-6 GB / Max Concurrency 200。**GPU 不可** ・ Cold Start あり ・ 軽量モデル + 間欠リクエスト向き。**Real-time / Async / Batch** と使い分け。" },
  { id: "mls-q70", category: "MLOps", difficulty: 3, question: "**SageMaker Projects** の用途として最も適切なものを選びなさい。", choices: ["CloudFormation テンプレで MLOps 環境(Repo / Pipeline / Endpoint)を一括構築", "学習用", "GUI", "認証"], correctIndex: 0, explanation: "**SageMaker Projects**: Service Catalog + CloudFormation で MLOps 標準環境を **1-Click で複数プロジェクト**に展開。**MLOps Template**(Custom 可)で組織標準化。" },
  { id: "mls-q71", category: "Distributed", difficulty: 3, question: "**Sharded Data Parallel(SDP)** の利点として最も適切なものを選びなさい。", choices: ["大規模モデルを GPU 間分割 → 単 GPU に収まらないモデル学習可", "GPU 削減", "GUI", "認証"], correctIndex: 0, explanation: "**SDP**(SageMaker Model Parallel): モデル + Optimizer State を GPU 間分割。**DeepSpeed ZeRO / FSDP**と同コンセプト。LLM / 大規模 NN 学習に必須。" },
  { id: "mls-q72", category: "Edge", difficulty: 3, question: "**SageMaker Neo** の用途として最も適切なものを選びなさい。", choices: ["モデルをエッジ / IoT デバイス向けに最適化 ・ コンパイル", "GUI", "学習用", "認証"], correctIndex: 0, explanation: "**SageMaker Neo**: TF / PyTorch / ONNX を Edge(Inferentia / Jetson / Raspberry Pi 等)向けに最適化コンパイル。**IoT Greengrass** で配布。" },
  { id: "mls-q73", category: "RAG", difficulty: 3, question: "**SageMaker JumpStart** の機能として **誤っているもの** を選びなさい。", choices: ["事前学習モデル + データセット + Notebook を 1-Click 利用", "RAG with Bedrock 連携", "Fine-tune Examples", "DB バックアップ"], correctIndex: 3, explanation: "**JumpStart**: Llama / Stable Diffusion / Falcon / Mistral などの Foundation Model を 1-Click 利用 + Fine-tune Example + Solution Templates(産業別)+ Bedrock 統合。" },
  { id: "mls-q74", category: "Pipeline", difficulty: 3, question: "**SageMaker Pipelines の Conditional Step** の用途として最も適切なものを選びなさい。", choices: ["評価メトリクスが閾値超え → モデル登録 / Approve ・ それ以外 → Skip", "認証", "GPU", "Cost"], correctIndex: 0, explanation: "**ConditionStep**: `IF accuracy > 0.9 THEN RegisterModel ELSE Stop`。**自動化された品質ゲート**で本番モデルへの昇格を制御。**CodePipeline Action** とも連携可。" },
  { id: "mls-q75", category: "Monitor", difficulty: 3, question: "**SageMaker Model Monitor の Data Quality** で **誤っているもの** を選びなさい。", choices: ["Missing 検出", "Schema Drift", "Statistical Drift(KS / EMD)", "GPU 監視"], correctIndex: 3, explanation: "**Data Quality Monitor**: ① Missing / Schema Type ② Statistical Drift(Kolmogorov-Smirnov / Earth Mover's Distance)③ Distinct Values。**Baseline 生成** → Schedule で本番比較。" },
  { id: "mls-q76", category: "Bias", difficulty: 3, question: "**SageMaker Clarify の Pre-training Bias** 指標として **誤っているもの** を選びなさい。", choices: ["Class Imbalance(CI)", "Difference in Positive Proportions in Labels(DPL)", "KL / JS / LP / TVD Divergence", "GPU Bias"], correctIndex: 3, explanation: "**Clarify Pre-training**: CI / DPL / KL / JS / LP-norm / TVD / KS / Conditional Demographic Disparity。**Post-training**: DPPL / DI / RD / AD / CDDPL 等。" },
  { id: "mls-q77", category: "Security", difficulty: 3, question: "**SageMaker Privacy** で **Differential Privacy** を提供するサービスとして最も適切なものを選びなさい。", choices: ["SageMaker Clarify(2024 DP 機能)/ Custom Training Loop で DP-SGD", "全データ平文公開", "GUI", "認証"], correctIndex: 0, explanation: "**SageMaker DP**: Clarify Eval Pre-training Bias で個人特定リスク評価 + Custom DP-SGD(Opacus 等で実装)。**Macie / GuardDuty** と組合せて Privacy Pipeline 構築。" },
  { id: "mls-q78", category: "Bedrock", difficulty: 3, question: "**SageMaker と Bedrock** の使い分けとして最も適切なものを選びなさい。", choices: ["SageMaker=学習 + 細かい制御、Bedrock=Foundation Model API + マネージド", "両者同じ", "Bedrock=学習専用", "SageMaker=API のみ"], correctIndex: 0, explanation: "**SageMaker**: 学習 / カスタム / Tabular ・ 古典 ML。**Bedrock**: Foundation Model API ・ Anthropic / Cohere / Mistral / Meta / AI21 / Amazon。**SageMaker JumpStart 経由で Foundation Model 学習** も可。" },
  { id: "mls-q79", category: "Cost 戦略", difficulty: 3, question: "**SageMaker Asynchronous Inference** の典型用途として最も適切なものを選びなさい。", choices: ["大ペイロード / 長時間推論(1 MB-1 GB / 1 時間まで)・ キューイング", "リアルタイム", "GPU 不要", "認証"], correctIndex: 0, explanation: "**Async Inference**: SQS 経由でキューイング ・ Spot / Auto Scaling to 0 対応。**動画解析 / 大規模文書 / マルチモーダル**で活用。Real-time(<60s)/ Batch(オフライン)と使い分け。" },
  { id: "mls-q80", category: "Cert", difficulty: 2, question: "**MLS-C01** の位置づけとして最も適切なものを選びなさい。", choices: ["Specialty レベル(AIF / MLA より上、SAP と同等難易度)", "Cloud Practitioner", "Foundational", "Fundamentals"], correctIndex: 0, explanation: "**MLS-C01**(2024 リニューアル予定): **Specialty レベル**。**AIF-C01(F)→ MLA-C01(Associate)→ MLS-C01(Specialty)** の階層。**AIエンジニア ・ ML Engineer 実務者**向け。" },
];
