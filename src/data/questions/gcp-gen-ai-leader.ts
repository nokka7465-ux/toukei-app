...
export const gcpGenAiLeaderQuestions: Question[] = [
  ...
  { id: "gcpgai-q66", category: "Gemini", difficulty: 2, question: "**Gemini ファミリ** の階層として最も適切なものを選びなさい。", choices: ["Ultra > Pro > Flash > Flash-Lite > Nano(性能順)", "Pro > Ultra", "Nano > Pro", "全て同等"], correctIndex: 0, explanation: "**Gemini Family**: **Ultra**(最高性能 ・ 巨大)・ **Pro**(汎用)・ **Flash**(高速 ・ 低コスト)・ **Flash-Lite**(さらに軽量)・ **Nano**(オンデバイス Android / Chrome)。" },
  { id: "gcpgai-q67", category: "Gemini", difficulty: 2, question: "**Gemini 2.0 / 2.5**(2024-2025)の進化として **誤っているもの** を選びなさい。", choices: ["Native Multimodal(画像 / 音声 / 動画統合)", "Agent / Function Calling 強化", "Thinking(o-series 風)Mode", "Context 1K Token のみ"], correctIndex: 3, explanation: "**Gemini 2.0+**: **Native Multimodal**(Sora 級 動画 + Veo / Imagen 統合)・ **Agent**(Project Astra)・ **Thinking**(2.0 Flash Thinking, 2.5 Pro)・ **Context 100 万-200 万 Token**。" },
  { id: "gcpgai-q68", category: "Vertex AI", difficulty: 2, question: "**Vertex AI Search**(旧 Enterprise Search)の用途として最も適切なものを選びなさい。", choices: ["マネージド RAG: 取込 → ベクトル化 → 検索 → Citation 付き応答", "学習用", "GUI", "認証 SSO"], correctIndex: 0, explanation: "**Vertex AI Search**: 構造化 + 非構造化 + マルチモーダル取込 → **Datastore + Reranker** → Search & Conversational App。**Vertex AI Agent Builder**(Search + Dialogflow CX)の中核。" },
  { id: "gcpgai-q69", category: "Vertex AI", difficulty: 2, question: "**Vector Search**(旧 Matching Engine)の特徴として最も適切なものを選びなさい。", choices: ["ScaNN ベース ANN ・ 数十億ベクトル ms 級検索", "BM25", "GUI", "認証"], correctIndex: 0, explanation: "**Vector Search**: Google ScaNN(Scalable Nearest Neighbors)製。**Hybrid Search**(疎+密)・ **Filter / Crowding** 対応。**Vertex AI Search の Backend** として活用。" },
  { id: "gcpgai-q70", category: "Tuning", difficulty: 2, question: "**Gemini Fine-tuning** の対応方式として **誤っているもの** を選びなさい。", choices: ["Supervised Fine-tuning(SFT)", "RLHF / DPO", "LoRA / Adapter ベース", "Full Pretraining"], correctIndex: 3, explanation: "**Gemini Tuning**: SFT(教師あり)・ **LoRA / Adapter**(マネージド)・ **Distillation**(Preview)。**Full Pretraining は提供されない**(コスト / IP)。Vertex AI Studio / API で実行。" },
  { id: "gcpgai-q71", category: "Agent", difficulty: 2, question: "**Project Astra**(Google AI 2024)の特徴として最も適切なものを選びなさい。", choices: ["マルチモーダル(動画 + 音声)+ 低レイテンシ + Persistent Memory", "テキスト専用", "GUI", "認証"], correctIndex: 0, explanation: "**Astra**(Google I/O 2024 発表 ・ 2025 展開): **Real-time Multimodal Agent**。**OpenAI Realtime API / GPT-4o Voice Mode** に対応。携帯 / スマートグラス連携。" },
  { id: "gcpgai-q72", category: "Imagen", difficulty: 2, question: "**Imagen 3 / Veo**(2024)の用途として最も適切なものを選びなさい。", choices: ["Imagen=高品質画像生成、Veo=動画生成(Sora 級)", "両者音声", "学習用", "認証"], correctIndex: 0, explanation: "**Imagen 3**: テキスト → 高解像度画像。**Veo**(2024): 60 秒+ の高品質動画生成。**SynthID Watermark** で出所証明。**DALL-E 3 / Midjourney / Flux / Sora** と競合。" },
  { id: "gcpgai-q73", category: "Safety", difficulty: 2, question: "**Vertex AI Safety Filter** の **Threshold** 設定値として最も適切なものを選びなさい。", choices: ["BLOCK_NONE / LOW / MED / HIGH の 4 段階", "ON / OFF のみ", "GPU 値", "認証"], correctIndex: 0, explanation: "**Safety**: 4 カテゴリ(Harassment / Hate / Sexually Explicit / Dangerous)× 4 Threshold(NONE / LOW / MED / HIGH)。**Content Filter + Citation 検出 + Recitation Check**。" },
  { id: "gcpgai-q74", category: "Responsible AI", difficulty: 2, question: "**Google Responsible AI** で **2018 AI 原則** の禁止用途として **誤っているもの** を選びなさい。", choices: ["武器 / 監視(国際法違反)", "重大な傷害を引き起こす技術", "国際法 / 人権侵害", "業務効率化"], correctIndex: 3, explanation: "**Google AI Principles 禁止用途**: ① 武器 ② 不当監視 ③ 重大傷害 ④ 国際法 / 人権侵害。**業務効率化は禁止ではない**(むしろ推奨される領域)。" },
  { id: "gcpgai-q75", category: "Compliance", difficulty: 2, question: "**EU AI Act** で **GPAI(General Purpose AI)** に課される義務として **誤っているもの** を選びなさい。", choices: ["技術文書 + 著作権ポリシー公開", "学習データサマリ公開", "Systemic Risk GPAI は追加義務(評価 / インシデント報告)", "全 AI 利用禁止"], correctIndex: 3, explanation: "**EU AI Act GPAI**: 技術文書 / 著作権 / Training Data Summary。**Systemic Risk**(>10^25 FLOPs): モデル評価 / インシデント報告 / Cybersecurity。全面禁止ではない。" },
  { id: "gcpgai-q76", category: "Cost", difficulty: 2, question: "**Generative AI コスト最適化** として **誤っているもの** を選びなさい。", choices: ["Context Caching(75% off)", "Batch Prediction(50% off)", "Model 使い分け(Flash / Pro / Ultra)", "全リクエスト Ultra 強制"], correctIndex: 3, explanation: "**Cost 最適化**: Context Caching / Batch / Model 選定 / Streaming UI / RAG で Prompt 短縮 / Function Calling。**Always Ultra**は無駄(タスク難易度別最適化)。" },
  { id: "gcpgai-q77", category: "業界", difficulty: 2, question: "**医療 × 生成 AI**(Google Med-PaLM / MedLM)の特徴として最も適切なものを選びなさい。", choices: ["医療試験で人間専門医同等 → ただし最終診断は医師 + HIPAA 準拠必須", "完全自動診断 OK", "規制無視", "認証"], correctIndex: 0, explanation: "**MedLM / Med-PaLM 2**: USMLE 85%+。**用途**: 医師補助 / 文書要約 / 患者教育。**最終診断は医師 + HIPAA / GDPR / 個情法 / Drug Approval 規制遵守**。" },
  { id: "gcpgai-q78", category: "業界", difficulty: 2, question: "**法律 × 生成 AI** の典型ユースケースとして **誤っているもの** を選びなさい。", choices: ["契約書レビュー / リサーチ", "判例検索 / Memo Drafting", "クライアント対応支援", "弁護士の完全代替"], correctIndex: 3, explanation: "**Legal AI**: Harvey / Spellbook / Lexis+ AI / Casetext。**弁護士業務効率化 + Augmentation**(完全代替ではない)。**Hallucination + 守秘義務**で慎重運用必須。" },
  { id: "gcpgai-q79", category: "Future", difficulty: 2, question: "**AI Agent の今後トレンド**(2025)として **誤っているもの** を選びなさい。", choices: ["Multi-Agent Collaboration", "Computer Use(画面操作 / ブラウザ自動化)", "Persistent Memory / Episodic Memory", "完全人間置換"], correctIndex: 3, explanation: "**Agent Trends 2025**: Multi-Agent / Computer Use(Claude / Operator)/ Memory / Reasoning Models(o1 / Gemini Thinking)/ Voice / Embodied。**Human-in-the-Loop が主流** で完全置換ではない。" },
  { id: "gcpgai-q80", category: "Cert", difficulty: 1, question: "**Generative AI Leader** の **位置づけ** として最も適切なものを選びなさい。", choices: ["Foundational(Cloud Digital Leader と同等 ・ ビジネス + 生成 AI 入門)", "Associate", "Professional", "Specialty"], correctIndex: 0, explanation: "**Gen AI Leader**(2024 リリース): Foundational ・ ビジネス + ML / Gen AI 概観 + Responsible AI + 業界 ・ ユースケース。**Cloud Digital Leader と並ぶ最易レベル**。次は Pro ML Engineer。" },
];
