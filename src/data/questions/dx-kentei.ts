...
export const dxKenteiQuestions: Question[] = [
  ...
  { id: "dx-q66", category: "Strategy", difficulty: 3, question: "**DX 成功 5 要素** として **誤っているもの** を選びなさい。", choices: ["経営者コミット + ビジョン", "デジタル人材育成 + 組織変革", "アジャイル + 失敗許容文化", "全社員 GPU 配布"], correctIndex: 3, explanation: "**DX 成功要因**: ① 経営者コミット ② ビジョン ③ 人材 / 組織 ④ アジャイル + 文化 ⑤ データ / 技術基盤 + 業務改革。**人と組織が最大課題**で技術は手段。" },
  { id: "dx-q67", category: "Strategy", difficulty: 3, question: "**Lean Startup** の MVP(Minimum Viable Product)の意義として最も適切なものを選びなさい。", choices: ["最小機能で市場検証 → Build-Measure-Learn ループ高速化", "全機能完成", "認証", "GPU"], correctIndex: 0, explanation: "**Lean Startup**(Ries 2011): MVP で仮説検証 → **Build-Measure-Learn**。**Pivot**(方向転換)・ **Innovation Accounting**。**Lean Canvas** で仮説整理。" },
  { id: "dx-q68", category: "Cloud", difficulty: 3, question: "**Public / Private / Hybrid / Multi-Cloud** の選択基準として **誤っているもの** を選びなさい。", choices: ["コンプライアンス / データ主権", "コスト / スケール / 機能", "ベンダーロックイン回避", "GPU 個数最大化"], correctIndex: 3, explanation: "**Cloud 選択**: ① 規制 / 主権 ② コスト / 性能 ③ ベンダー戦略 ④ 既存環境 / 移行性 ⑤ 人材スキル。**Multi-Cloud は管理コスト増**もありメリットとのバランス。" },
  { id: "dx-q69", category: "Cloud", difficulty: 3, question: "**IaaS / PaaS / SaaS / FaaS** の責任共有モデルで最も顧客責任が **少ない** のはどれか。", choices: ["SaaS", "IaaS", "PaaS", "FaaS"], correctIndex: 0, explanation: "**責任共有**: IaaS(OS / App)> PaaS(App)> **SaaS**(設定のみ)。**FaaS(Serverless)** は Code + Config のみで PaaS と SaaS の中間。" },
  { id: "dx-q70", category: "Data", difficulty: 3, question: "**Data Driven 文化** の阻害要因として **誤っているもの** を選びなさい。", choices: ["Data Silo / Tool バラバラ", "リテラシ不足 / Data 民主化不在", "意思決定が経験 ・ 直感のみ", "AI / BI 活用"], correctIndex: 3, explanation: "**Data-Driven 阻害**: Silo / リテラシ / Top-down 経験主義 / Data Quality 不足 / Governance 不在。**AI / BI 活用は推進要因**で阻害ではない。" },
  { id: "dx-q71", category: "AI 戦略", difficulty: 3, question: "**生成 AI 業務活用** の **典型 ROI 領域** として **誤っているもの** を選びなさい。", choices: ["文書要約 ・ 翻訳 ・ ドラフト", "コード補完(Copilot)", "コールセンター応対 + RAG", "物理的サーバ製造"], correctIndex: 3, explanation: "**Generative AI ROI**: 知的労働(文書 / コード / 議事録 / RAG / Image / Marketing)で大きい。**物理製造はロボティクス / VLA で別領域**。" },
  { id: "dx-q72", category: "Cybersecurity", difficulty: 3, question: "**ランサムウェア対策** として **誤っているもの** を選びなさい。", choices: ["3-2-1 バックアップ + Air-Gap", "EDR / Zero Trust / 多要素認証", "従業員教育 + Phishing 訓練", "全データ Public 公開"], correctIndex: 3, explanation: "**Ransom 対策**: 3(コピー)-2(媒体)-1(オフサイト)+ Air-Gap / Immutable / Patching / EDR / Zero Trust / MFA / 教育 / 復旧訓練。**公開は致命的**。" },
  { id: "dx-q73", category: "Workforce", difficulty: 3, question: "**DX 推進** の人材タイプとして **誤っているもの** を選びなさい。", choices: ["Business Translator / Product Manager", "Data Scientist / Engineer / Architect", "UX Designer / Researcher", "GPU 製造工"], correctIndex: 3, explanation: "**DX 人材**: ストラテジスト / Product Mgr / Business Translator / Data Sci / Eng / Architect / UX / Cyber / Change Management。**T 字型 / π 型人材**の育成。" },
  { id: "dx-q74", category: "Innovation", difficulty: 3, question: "**Design Thinking** の 5 ステップとして **誤っているもの** を選びなさい。", choices: ["Empathize / Define", "Ideate / Prototype", "Test", "Outsource"], correctIndex: 3, explanation: "**Design Thinking**(Stanford d.school): Empathize → Define → Ideate → Prototype → Test の反復。**ユーザー中心 ・ 共感 ・ 高速試作 ・ 検証**が肝。" },
  { id: "dx-q75", category: "Sustainability", difficulty: 3, question: "**ESG / SDGs** と DX の関係として最も適切なものを選びなさい。", choices: ["Green IT / Carbon-Aware Computing で環境貢献 + データで Reporting 強化", "無関係", "コスト最優先", "GPU 削減のみ"], correctIndex: 0, explanation: "**ESG × DX**: Green IT(PUE / Renewable / Carbon-Aware Scheduling)+ ESG Reporting(SBTi / TCFD / GRI)+ 循環経済 / Supply Chain 可視化(IoT / Blockchain)。" },
  { id: "dx-q76", category: "Regulation", difficulty: 3, question: "**EU AI Act** の **2024 施行** で **High Risk AI** に課される主要義務として **誤っているもの** を選びなさい。", choices: ["リスクマネジメントシステム", "Training Data Governance / Logging", "Human Oversight + Robustness", "全 AI 完全自動化必須"], correctIndex: 3, explanation: "**EU AI Act**: Unacceptable / **High** / Limited / Minimal の 4 階層。**High** = リスク管理 / データ品質 / Log / Transparency / Human Oversight / Robustness / Cybersecurity 義務。" },
  { id: "dx-q77", category: "Edge", difficulty: 3, question: "**Edge AI** の利点として **誤っているもの** を選びなさい。", choices: ["低レイテンシ / 帯域節約", "プライバシ強化(オンデバイス)", "オフライン動作", "クラウド GPU 無制限"], correctIndex: 3, explanation: "**Edge AI**: 端末側で推論 → Latency / Privacy / 帯域 / オフライン。**NVIDIA Jetson / Apple Neural Engine / Qualcomm AI Engine**。**Federated Learning + Edge** でプライバシ保護 ML。" },
  { id: "dx-q78", category: "業界 DX", difficulty: 3, question: "**金融 DX**(Embedded Finance / DeFi)の代表的特徴として **誤っているもの** を選びなさい。", choices: ["API バンキング / BaaS", "AI 与信 / 不正検知", "Tokenization / Blockchain 決済", "紙の通帳のみ"], correctIndex: 3, explanation: "**金融 DX**: Open Banking / BaaS / 決済 API / AI 与信 / Robo Advisor / DeFi / Tokenization / Embedded Finance(EC 内決済)。**紙の通帳は DX 対極**。" },
  { id: "dx-q79", category: "業界 DX", difficulty: 3, question: "**製造業 DX(Industry 4.0)** の中核要素として **誤っているもの** を選びなさい。", choices: ["IoT / Sensor + Edge", "Digital Twin + Simulation", "AI 予知保全 / Cobot", "全アナログ手作業のみ"], correctIndex: 3, explanation: "**Industry 4.0**: IoT(センサ / Edge)/ Digital Twin / AI 予知保全 / Cobot / AR-MR / Smart Factory / Supply Chain Visibility。日本は **Society 5.0** で Industry 5.0 を提唱。" },
  { id: "dx-q80", category: "Cert", difficulty: 2, question: "**DX 検定** の特徴として最も適切なものを選びなさい。", choices: ["★(初級)→ ★★(中級)→ ★★★(上級)の Score 型認定 ・ 広く浅く問う", "技術のみ", "数学のみ", "プログラミング必須"], correctIndex: 0, explanation: "**DX 検定**(日本イノベーション融合学会): Score 型認定 ・ ★(700+)/ ★★(800+)/ ★★★(900+)。**戦略 + 技術 + 業界 + 法令 ・ 倫理 + 文化**を広く問う ・ 経営者 ・ DX リーダー対象。" },
];
