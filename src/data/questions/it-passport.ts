...
export const itPassportQuestions: Question[] = [
  ...
  { id: "ip-q51", category: "経営戦略", difficulty: 2, question: "**コアコンピタンス** の意味として最も適切なものを選びなさい。", choices: ["他社が模倣困難な自社の中核的競争力", "売上トップの製品", "従業員数", "DBA スキル"], correctIndex: 0, explanation: "**コアコンピタンス**(Hamel & Prahalad): 模倣困難 ・ 多用途 ・ 顧客価値 という 3 条件。トヨタのカイゼン / Google の検索など。" },
  { id: "ip-q52", category: "経営戦略", difficulty: 2, question: "**M&A** の **シナジー効果** として **誤っているもの** を選びなさい。", choices: ["コスト削減 ・ 売上拡大 ・ 技術獲得", "重複部門の合理化", "市場シェア拡大", "従業員モラル必ず向上"], correctIndex: 3, explanation: "**M&A のシナジー**: コスト削減 / 売上拡大 / 技術獲得 / 市場拡大。**従業員のモラルは逆に下がるリスク** あり(統合課題)。" },
  { id: "ip-q53", category: "マーケティング", difficulty: 2, question: "**4P** に **含まれない** ものを選びなさい。", choices: ["Product", "Price", "Place", "People"], correctIndex: 3, explanation: "**マーケティング 4P**: Product / Price / Place / Promotion。**サービス業向けに 7P**(+ People / Process / Physical Evidence)もあり。" },
  { id: "ip-q54", category: "会計", difficulty: 2, question: "**損益計算書(P/L)** に表示されないものを選びなさい。", choices: ["売上高", "営業利益", "純資産", "当期純利益"], correctIndex: 2, explanation: "**P/L**: 期間の収益 ・ 費用 ・ 利益。**純資産は B/S(貸借対照表)**。P/L = フロー、B/S = ストック。" },
  { id: "ip-q55", category: "法務", difficulty: 3, question: "**著作権法 30 条の 4** が認める利用として最も適切なものを選びなさい。", choices: ["AI / 機械学習の情報解析目的(原則 OK)", "全て自由", "個人利用のみ", "認証必須"], correctIndex: 0, explanation: "**著作権法 30 条の 4**(2018 改正): 情報解析 ・ AI 学習目的の著作物利用を **広く認める**。**日本が AI 開発に寛容な国** と言われる根拠。" },
  { id: "ip-q56", category: "セキュリティ", difficulty: 3, question: "**SSL/TLS** の主な目的として **誤っているもの** を選びなさい。", choices: ["盗聴防止", "改ざん検知", "なりすまし防止", "DB バックアップ"], correctIndex: 3, explanation: "**TLS の 3 大機能**: 暗号化(盗聴防止)・ メッセージ認証(改ざん検知)・ サーバ認証(なりすまし防止)。バックアップは別系統。" },
  { id: "ip-q57", category: "セキュリティ", difficulty: 3, question: "**ゼロデイ攻撃** の意味として最も適切なものを選びなさい。", choices: ["脆弱性公開 / 修正パッチ前に行われる攻撃", "ログイン直後", "新人エンジニア向け", "0 USD コスト"], correctIndex: 0, explanation: "**Zero-Day**: 脆弱性が修正されるまでに行われる攻撃。**EDR / IDS / Sandbox / 振る舞い検知** で対策。CVE 番号で識別。" },
  { id: "ip-q58", category: "ネットワーク", difficulty: 2, question: "**LAN(Local Area Network)** の典型範囲として正しいものを選びなさい。", choices: ["事業所 ・ 建物内", "県全体", "国全体", "世界中"], correctIndex: 0, explanation: "**LAN**: 事業所 ・ 建物 ・ 家庭内。**MAN**(都市)・ **WAN**(広域 ・ インターネット)。**Ethernet / Wi-Fi** が代表技術。" },
  { id: "ip-q59", category: "プログラミング", difficulty: 2, question: "**プログラム言語の分類** で **インタプリタ型** に該当するものを選びなさい。", choices: ["Python / Ruby / JavaScript", "C / C++ / Rust", "アセンブラ", "機械語"], correctIndex: 0, explanation: "**インタプリタ型**: 1 行ずつ実行(Python / Ruby / JS)。**コンパイル型**: 事前に機械語化(C / C++ / Rust / Go)。**ハイブリッド**: Java / C#(中間 → JIT)。" },
  { id: "ip-q60", category: "AI", difficulty: 2, question: "**ChatGPT** の **基盤モデル** として正しいものを選びなさい。", choices: ["GPT(Generative Pre-trained Transformer)", "BERT", "ResNet", "K-Means"], correctIndex: 0, explanation: "**ChatGPT**: GPT(OpenAI 開発)+ RLHF で対話最適化。**Claude(Anthropic)・ Gemini(Google)・ Llama(Meta)** も類似アーキテクチャ。" },
  { id: "ip-q61", category: "AI", difficulty: 2, question: "**プロンプトエンジニアリング** の意味として最も適切なものを選びなさい。", choices: ["LLM に対する入力テキストを最適化する技術", "GPU 設計", "DB クエリ", "ネットワーク設定"], correctIndex: 0, explanation: "**Prompt Engineering**: LLM の応答品質を上げるための入力工夫。**Few-shot / CoT / Role / Structured Output** などの技法。" },
  { id: "ip-q62", category: "クラウド", difficulty: 2, question: "**クラウドの 3 大ベンダー** として **誤っているもの** を選びなさい。", choices: ["AWS(Amazon)", "Azure(Microsoft)", "GCP(Google)", "Linux"], correctIndex: 3, explanation: "**3 大クラウド**: AWS / Azure / GCP(全世界シェアの大半)。**Linux は OS** で、クラウド上で動くが別カテゴリ。" },
  { id: "ip-q63", category: "DX", difficulty: 2, question: "**メタバース** の代表的プラットフォームとして **誤っているもの** を選びなさい。", choices: ["Meta Horizon / VRChat / Roblox", "Fortnite", "Decentraland", "Microsoft Word"], correctIndex: 3, explanation: "**メタバース**: Meta(旧 Facebook)Horizon / VRChat / Roblox / Fortnite / Decentraland(Web3 系)。**Word は文書編集ソフト**。" },
  { id: "ip-q64", category: "倫理", difficulty: 2, question: "**ディープフェイク** の社会的問題として **誤っているもの** を選びなさい。", choices: ["なりすまし詐欺", "偽情報拡散", "選挙介入", "GPU 価格上昇"], correctIndex: 3, explanation: "**Deepfake**: AI 生成の偽動画 / 画像 / 音声。**なりすまし / 詐欺 / プロパガンダ** に悪用。**SynthID / 電子透かし** などで検知技術発展。" },
  { id: "ip-q65", category: "学習", difficulty: 1, question: "ITパスポート合格後の **AI 系入門資格** として最も適切なものを選びなさい。", choices: ["G 検定 ・ 生成 AI パスポート", "応用情報", "ストラテジスト", "簿記"], correctIndex: 0, explanation: "**ITパスポート → G 検定(AI 概念)・ 生成 AI パスポート(プロンプト ・ 倫理)** が AI 入門の自然な発展。**DS 検定** も並行可。" },
  { id: "ip-q66", category: "ストラテジ", difficulty: 2, question: "**SWOT 分析** の構成要素として最も適切なものを選びなさい。", choices: ["Strengths / Weaknesses / Opportunities / Threats", "売上 / 利益 / 資産 / 負債", "計画 / 実行 / 評価 / 改善", "技術 / 営業 / 開発 / 経理"], correctIndex: 0, explanation: "**SWOT**: 内部要因(強み / 弱み)+ 外部要因(機会 / 脅威)。**PEST**(政治 ・ 経済 ・ 社会 ・ 技術)・ **5 Forces**(競争分析)と組合せ。経営戦略分析の基礎。" },
  { id: "ip-q67", category: "ストラテジ", difficulty: 2, question: "**KPI と KGI** の関係として最も適切なものを選びなさい。", choices: ["KGI=最終目標、KPI=KGI 達成のための中間指標", "両者同じ", "KGI が KPI より小さい", "KPI=売上のみ"], correctIndex: 0, explanation: "**KGI**(Key Goal Indicator): 最終達成目標(売上 ・ 利益)。**KPI**(Key Performance Indicator): KGI 達成のプロセス指標(訪問件数 / コンバージョン率)。**OKR**(Objective + Key Results)も同様概念。" },
  { id: "ip-q68", category: "ストラテジ", difficulty: 2, question: "**BCP(事業継続計画)** の主目的として最も適切なものを選びなさい。", choices: ["災害 ・ 事故時に重要業務を継続 / 早期復旧", "売上最大化", "コスト削減のみ", "新規開拓"], correctIndex: 0, explanation: "**BCP**: 地震 ・ パンデミック ・ サイバー攻撃等で重要業務を継続。**RTO**(Recovery Time Objective)・ **RPO**(Recovery Point Objective)を定義。**BCM**(継続的マネジメント)で運用。" },
  { id: "ip-q69", category: "マネジメント", difficulty: 2, question: "**PMBOK** の **10 知識エリア** として **誤っているもの** を選びなさい。", choices: ["スコープ / スケジュール / コスト", "品質 / 資源 / コミュニケーション", "リスク / 調達 / ステークホルダ", "GPU 管理"], correctIndex: 3, explanation: "**PMBOK 10 エリア**: 統合 / スコープ / スケジュール / コスト / 品質 / 資源 / コミュニケーション / リスク / 調達 / ステークホルダ。**5 プロセス群**(立上げ / 計画 / 実行 / 監視 ・ コントロール / 終結)と組合せ。" },
  { id: "ip-q70", category: "マネジメント", difficulty: 2, question: "**ITIL** の主要プロセスとして **誤っているもの** を選びなさい。", choices: ["インシデント管理", "問題管理", "変更管理", "ベンチャー投資"], correctIndex: 3, explanation: "**ITIL 4**: サービスマネジメントのベストプラクティス。**インシデント / 問題 / 変更 / リリース / サービスレベル / 構成管理(CMDB)** など。ベンチャー投資は無関係。" },
  { id: "ip-q71", category: "テクノロジ", difficulty: 2, question: "**5G(第 5 世代移動通信)** の特徴として **誤っているもの** を選びなさい。", choices: ["高速大容量(eMBB)", "超低遅延(URLLC)", "多数同時接続(mMTC)", "音声通話のみ"], correctIndex: 3, explanation: "**5G 3 大特徴**: ① eMBB(高速大容量、10 Gbps)② URLLC(超低遅延、1ms)③ mMTC(多接続、100 万 / km²)。**自動運転 ・ IoT ・ AR / VR ・ 工場 DX** で活用。" },
  { id: "ip-q72", category: "テクノロジ", difficulty: 2, question: "**ブロックチェーン** の特徴として **誤っているもの** を選びなさい。", choices: ["分散台帳", "改ざん耐性 / ハッシュ連鎖", "スマートコントラクト", "中央集権サーバ必須"], correctIndex: 3, explanation: "**ブロックチェーン**: P2P 分散台帳 + ハッシュ連鎖 + コンセンサス(PoW / PoS)。**Bitcoin / Ethereum / Hyperledger**。**中央集権サーバ不要**が本質。**Web3 / NFT / DeFi** の基盤。" },
  { id: "ip-q73", category: "テクノロジ", difficulty: 2, question: "**メタバース** の典型的利用例として **誤っているもの** を選びなさい。", choices: ["VR 会議 / アバター", "デジタルツイン", "バーチャル店舗", "紙の本"], correctIndex: 3, explanation: "**メタバース**: VR / AR 上の 3D 仮想空間で交流 / 体験。**会議 ・ ショッピング ・ イベント ・ デジタルツイン(物理空間の仮想複製)**。Apple Vision Pro / Meta Quest が代表 HW。" },
  { id: "ip-q74", category: "セキュリティ", difficulty: 2, question: "**多要素認証(MFA)** の **要素** として **誤っているもの** を選びなさい。", choices: ["知識(パスワード)", "所持(スマホ / トークン)", "生体(指紋 / 顔)", "GPU 性能"], correctIndex: 3, explanation: "**MFA**: ① Knowledge(知識)② Possession(所持)③ Inherence(生体)の組合せ。**Passkey / FIDO2 / TOTP / SMS**(SMS は脆弱)。Zero Trust の中核。" },
  { id: "ip-q75", category: "セキュリティ", difficulty: 2, question: "**ランサムウェア** の対策として **誤っているもの** を選びなさい。", choices: ["定期バックアップ + Air-Gap", "OS / アプリの最新化", "EDR / アンチウイルス", "全データを公開"], correctIndex: 3, explanation: "**ランサム対策**: バックアップ + Air-Gap(物理隔離)+ 3-2-1 ルール + EDR + メール / リンク警戒 + Zero Trust + Patch 管理。**全公開は最悪のシナリオ**。" },
  { id: "ip-q76", category: "ストラテジ", difficulty: 2, question: "**サーキュラーエコノミー(循環型経済)** の特徴として最も適切なものを選びなさい。", choices: ["Reduce / Reuse / Recycle + Refurbish / Repair で資源循環", "使い捨て前提", "GPU 増設", "認証"], correctIndex: 0, explanation: "**Circular Economy**: 3R + Refurbish + Repair + Remanufacture + Reduce(設計段階から)。**EU CE Action Plan / 日本の循環型社会形成推進基本法**。ESG / SDGs と連携。" },
  { id: "ip-q77", category: "テクノロジ", difficulty: 2, question: "**量子コンピュータ** の基本単位として最も適切なものを選びなさい。", choices: ["量子ビット(Qubit)", "ビット", "Tensor", "Token"], correctIndex: 0, explanation: "**Qubit**: 0 と 1 の重ね合わせ + エンタングルメント → 古典で困難な問題を高速化(**Shor / Grover アルゴリズム**)。**IBM Quantum / Google Willow / 富士通**。実用化はまだ先。" },
  { id: "ip-q78", category: "テクノロジ", difficulty: 2, question: "**Edge Computing** の利点として最も適切なものを選びなさい。", choices: ["端末近くで処理 → 低レイテンシ + 帯域節約 + プライバシ", "クラウドのみ", "GPU 削減", "認証 SSO"], correctIndex: 0, explanation: "**Edge**: IoT / カメラ / ロボット等の端末側で前処理。**Cloud + Edge ハイブリッド**で 5G 環境を活用。**Cloudflare Workers / Vercel Edge / AWS Wavelength**。" },
  { id: "ip-q79", category: "AI", difficulty: 2, question: "**Copilot / 生成 AI** をオフィスで使う場合の典型注意点として **誤っているもの** を選びなさい。", choices: ["機密データの入力可否確認", "出力の事実確認(ハルシネーション)", "著作権 ・ ライセンス確認", "全社員に GPU 配布"], correctIndex: 3, explanation: "**業務生成 AI 留意点**: 機密入力 / ハルシネーション / 著作権 / ガイドライン遵守 / 監査 / 教育。GPU 配布は不要(クラウド経由が大半)。**Microsoft 365 Copilot / Google Workspace Gemini / Notion AI** が代表。" },
  { id: "ip-q80", category: "実務", difficulty: 1, question: "IT パスポート試験で重視される **総合 IT リテラシ** として最も適切なものを選びなさい。", choices: ["ストラテジ + マネジメント + テクノロジの 3 領域を社会人視点で理解", "プログラミングのみ", "GUI 操作のみ", "数学のみ"], correctIndex: 0, explanation: "**IT パスポート 3 領域**: ① ストラテジ系(経営 / 業務 / 法務)② マネジメント系(PM / SM)③ テクノロジ系(基礎 / 開発 / NW / DB / SEC / AI)。**社会人 IT リテラシ**の事実上の標準。" },
];
