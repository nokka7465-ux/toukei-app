...
export const dsLiteracyQuestions: Question[] = [
  ...
  { id: "dsl-q51", category: "ビジネス力", difficulty: 3, question: "**ROI(Return on Investment)** が **0.2** のとき意味として正しいものを選びなさい。", choices: ["投資額に対し 20% の利益(収益)", "投資の 20% を回収", "投資を 20 倍に増やす", "リスク 20%"], correctIndex: 0, explanation: "**ROI = (利益 / 投資額)× 100%**。0.2 = 20% の収益率。**ROI > 0 で利益、< 0 で赤字、目安は WACC を上回ること**。" },
  { id: "dsl-q52", category: "ビジネス力", difficulty: 3, question: "**コホート分析** の用途として最も適切なものを選びなさい。", choices: ["特定期間に獲得した顧客群の継続率を時系列追跡", "全顧客の平均", "売上トップ商品", "GPU 監視"], correctIndex: 0, explanation: "**Cohort Analysis**: ユーザを獲得月などでグループ化 → リテンション ・ ARPU を時系列追跡。**SaaS / アプリのチャーン分析** で必須。" },
  { id: "dsl-q53", category: "DS 力", difficulty: 3, question: "**Logistic Regression** の **オッズ比** の解釈として最も適切なものを選びなさい。", choices: ["説明変数 1 単位増 で起こる確率 / 起こらない確率の倍率変化", "確率の差", "標準偏差", "R²"], correctIndex: 0, explanation: "**オッズ比 = $e^{\\beta_i}$**。例: $\\beta = 0.693$ → OR = 2 → 説明変数 1 単位増で odds が 2 倍。Logistic 回帰の解釈の核心。" },
  { id: "dsl-q54", category: "DS 力", difficulty: 3, question: "**Random Forest** が **決定木 1 本** より優れる主な理由として最も適切なものを選びなさい。", choices: ["Bagging + 特徴量ランダム選択で分散低減 ・ 過学習抑制", "速度向上のみ", "ラベル不要", "GPU 必須"], correctIndex: 0, explanation: "**RF**: Bootstrap サンプル + ランダム特徴量 + 多数決 ・ 平均。**Bias 大 / Variance 小** の決定木を多数集めて Variance を削減。" },
  { id: "dsl-q55", category: "DE 力", difficulty: 3, question: "**Feature Store** の主目的として最も適切なものを選びなさい。", choices: ["特徴量を再利用可能に管理 + Train/Serve スキュー回避", "GPU 共有", "DB バックアップ", "認証"], correctIndex: 0, explanation: "**Feature Store**: Feast / SageMaker FS / Vertex AI FS / Tecton。**Offline(学習用)+ Online(推論用低レイテンシ)** + Train/Serve 一貫性保証。" },
  { id: "dsl-q56", category: "DE 力", difficulty: 3, question: "**Apache Airflow** の **DAG** の意味として最も適切なものを選びなさい。", choices: ["Directed Acyclic Graph(タスク依存グラフ)", "Database Access Gateway", "Distributed Allocation Group", "GUI"], correctIndex: 0, explanation: "**Airflow DAG**: タスクの依存関係を Python で定義 → Airflow Scheduler が実行。**Composer(GCP)/ MWAA(AWS)/ Astronomer** などのマネージド版あり。" },
  { id: "dsl-q57", category: "DS 力", difficulty: 3, question: "**Gradient Boosting** の代表ライブラリとして **誤っているもの** を選びなさい。", choices: ["XGBoost / LightGBM / CatBoost", "AutoML 系統(H2O / Auto-sklearn)", "Scikit-learn の HistGradientBoosting", "PCA"], correctIndex: 3, explanation: "**GBDT**: XGBoost / LightGBM / CatBoost / HistGradientBoosting が代表。**Kaggle で勝ち続けるアルゴリズム**。PCA は次元削減で別系統。" },
  { id: "dsl-q58", category: "可視化", difficulty: 3, question: "**Heatmap** の用途として最も適切なものを選びなさい。", choices: ["2 次元データ ・ 行列の値を色で表現(相関行列 / 混同行列等)", "1 変数の分布", "時系列", "ランダム"], correctIndex: 0, explanation: "**Heatmap**: 行列 ・ 2 次元データの可視化。**相関行列 / 混同行列 / クラスタリング結果 / GIS データ** で頻用。Seaborn `sns.heatmap()` で簡単。" },
  { id: "dsl-q59", category: "MLOps", difficulty: 3, question: "**Model Drift Monitoring** が必要な理由として最も適切なものを選びなさい。", choices: ["時間経過で分布が変わり性能劣化 → 検知 → 再学習トリガ", "GUI 改善", "ストレージ削減", "認証強化"], correctIndex: 0, explanation: "**Drift Monitoring**: Data Drift(入力分布変化)・ Concept Drift(出力関係変化)を継続監視。**PSI / KS / KL** などで定量化。**Evidently AI / WhyLabs** などツールあり。" },
  { id: "dsl-q60", category: "倫理", difficulty: 3, question: "**個人情報の匿名化** で **k-匿名性** の意味として最も適切なものを選びなさい。", choices: ["同一の属性組合せ(Quasi-identifier)を持つレコードが少なくとも k 人いる", "k 個の暗号化", "k 番目のレコード削除", "GPU 共有"], correctIndex: 0, explanation: "**k-匿名性**(Sweeney 2002): 各レコードが少なくとも k-1 人と区別不可。**l-多様性 / t-近似性 / 差分プライバシ** が発展形。GDPR / 個人情報保護法対応で活用。" },
  { id: "dsl-q61", category: "コミュニケーション", difficulty: 3, question: "**データ分析結果の経営層プレゼン** で **最も重要な要素** を選びなさい。", choices: ["『So what?』(So Action)を明確化 → ビジネスインパクト + 推奨アクション", "技術詳細", "計算式", "GPU 利用率"], correctIndex: 0, explanation: "**経営層プレゼン**: 結論 → 根拠(可視化)→ 推奨アクション → リスク。**So What 思考** が重要。McKinsey の Pyramid Principle 。" },
  { id: "dsl-q62", category: "実務", difficulty: 3, question: "**A/B テスト** で **新機能を全ユーザに展開する前** にやるべきこととして最も適切なものを選びなさい。", choices: ["Sample Size 計算 + α / β / Effect Size を事前合意", "後付け解析", "p-hacking", "全ユーザ一気に展開"], correctIndex: 0, explanation: "**A/B テスト計画**: ① 仮説 + Metric ② 必要サンプル数 ③ α / β / MDE ④ ランダム化 ⑤ Duration ⑥ Decision Rule を **事前合意**。後付け解釈は不可。" },
  { id: "dsl-q63", category: "実務", difficulty: 3, question: "**因果推論** の **観察データ手法** で **マッチング法** の代表的指標として最も適切なものを選びなさい。", choices: ["Propensity Score", "p 値", "AUC", "GPU 数"], correctIndex: 0, explanation: "**Propensity Score Matching**: 処置確率を Logistic 回帰等で推定 → 似た PS の処置 / 非処置者をマッチング → 因果効果推定。**Causal Inference の基本手法**。" },
  { id: "dsl-q64", category: "AI 倫理", difficulty: 3, question: "**AI 倫理ガイドライン** で **共通的な原則** として **誤っているもの** を選びなさい。", choices: ["公平性 / 透明性 / 説明責任", "プライバシ / セキュリティ", "人間中心 / 人間の監督", "利益最大化のみ"], correctIndex: 3, explanation: "**AI 倫理 7 原則**(OECD / G7): Inclusive Growth / Human-centered / Transparency / Robustness / Accountability / Fairness / Privacy。利益最大化は経済原則。" },
  { id: "dsl-q65", category: "学習", difficulty: 1, question: "**データサイエンティスト** の **キャリアパス** として **誤っているもの** を選びなさい。", choices: ["Analytics(BI 寄り)", "ML Engineer(実装寄り)", "Research(研究寄り)", "DBA(リレーショナル DB 専門)"], correctIndex: 3, explanation: "**DS のキャリアパス**: Analytics → ML Engineer → ML Researcher / DS Manager / DS Lead / Data Architect / Chief Data Officer。DBA は別職種(OLTP / 性能 ・ 運用)。" },
  { id: "dsl-q66", category: "AI 活用", difficulty: 2, question: "**生成 AI 活用** で **業務効率化** に直結する典型ユースケースとして **誤っているもの** を選びなさい。", choices: ["議事録要約 ・ 文書翻訳", "コード補完(Copilot)", "問合せ対応のドラフト生成", "重要意思決定の完全自動化"], correctIndex: 3, explanation: "**生成 AI ユースケース**: 要約 / 翻訳 / コード / ドラフト / アイデア発想 / RAG 検索。**重要意思決定は Human-in-the-Loop**(精度 ・ 説明責任 ・ 倫理)を原則。" },
  { id: "dsl-q67", category: "LLM", difficulty: 2, question: "**Hallucination(ハルシネーション)** の意味として最も適切なものを選びなさい。", choices: ["LLM が事実と異なる内容を尤もらしく生成する現象", "GPU エラー", "ネットワークエラー", "認証失敗"], correctIndex: 0, explanation: "**Hallucination**: 学習データに無い情報を作り出す ・ Knowledge Cutoff・ 過剰自信。対策: **RAG / Grounding / Citation / Fact-Check / Self-Consistency / Temperature 低下**。" },
  { id: "dsl-q68", category: "Prompting", difficulty: 2, question: "**Few-shot Learning** の意味として最も適切なものを選びなさい。", choices: ["プロンプトに数例の入出力例を含めて新タスクを学習(In-Context Learning)", "学習データ大量", "GPU 削減", "認証"], correctIndex: 0, explanation: "**Few-shot**(In-Context Learning): プロンプト内例で重み変更なしでタスク習得。**Zero-shot < Few-shot < Fine-tuning** が一般的精度順。**Chain-of-Thought** と組合せで強力。" },
  { id: "dsl-q69", category: "可視化", difficulty: 2, question: "**ダッシュボード設計** で **避けるべきアンチパターン** として最も適切なものを選びなさい。", choices: ["1 画面に過剰指標詰込 ・ 3D グラフ ・ 軸操作", "KPI ハイライト", "余白活用", "Drill-Down"], correctIndex: 0, explanation: "**ダッシュボードアンチパターン**: 詰込 / 3D / 軸切捨 / 派手な色 / 単位混在 / 説明文不足。**Stephen Few - Information Dashboard Design** が古典。**1 画面 1 メッセージ ・ KPI Hierarchy** を遵守。" },
  { id: "dsl-q70", category: "統計", difficulty: 2, question: "**Simpson's Paradox** が表す現象として最も適切なものを選びなさい。", choices: ["群別では一貫した傾向が、全体集計で逆転する現象", "GPU 競合", "ネットワーク輻輳", "認証失敗"], correctIndex: 0, explanation: "**Simpson's Paradox**: グループ別 vs 集計で傾向逆転。**バークレー大入試 / 治療効果 / コホート分析** で典型。**因果図 / 層化 / 適切な統計モデル**で対処。" },
  { id: "dsl-q71", category: "倫理", difficulty: 2, question: "**AI バイアス** の主要因として **誤っているもの** を選びなさい。", choices: ["学習データの偏り", "ラベラーの主観", "プロキシ変数(郵便番号→人種代理)", "GPU メーカー"], correctIndex: 3, explanation: "**AI バイアス源**: データ偏り / ラベラー主観 / プロキシ変数 / Feedback Loop / Algorithmic Bias。GPU メーカーは無関係。**Fairlearn / AIF360 / Aequitas** で診断 ・ 緩和。" },
  { id: "dsl-q72", category: "Governance", difficulty: 2, question: "**Model Card / Data Sheet** の目的として最も適切なものを選びなさい。", choices: ["モデル / データの仕様 ・ 制約 ・ バイアスを文書化し透明性確保", "認証管理", "GPU 監視", "Cost 管理"], correctIndex: 0, explanation: "**Model Card**(Mitchell et al. 2019): モデルの用途 / 限界 / 評価指標 / Fairness 評価 / Ethical Considerations を記述。**Datasheets for Datasets**(Gebru)もペア。**Responsible AI** の柱。" },
  { id: "dsl-q73", category: "ML", difficulty: 2, question: "**MLOps** の中核概念として **誤っているもの** を選びなさい。", choices: ["バージョン管理(Code / Data / Model)", "CI / CD パイプライン", "Model Monitoring / Drift 検出", "GUI のみ最優先"], correctIndex: 3, explanation: "**MLOps**: DevOps + ML の運用化。**Versioning / CI/CD / Monitoring / Drift Detection / Feature Store / Model Registry / Experiment Tracking / Reproducibility**。GUI は補助。" },
  { id: "dsl-q74", category: "Privacy", difficulty: 2, question: "**差分プライバシー(Differential Privacy)** の特徴として最も適切なものを選びなさい。", choices: ["統計クエリにノイズを加え個人特定確率を数学的に保証", "Anonymization のみ", "GPU 削減", "認証"], correctIndex: 0, explanation: "**Differential Privacy**: $(\\epsilon, \\delta)$ で個人寄与の確率を制御。**Apple / Google / US Census** で実装。**Federated Learning**(生データ共有なし)と組合せでプライバシ ML。" },
  { id: "dsl-q75", category: "実務", difficulty: 2, question: "**A/B テスト** の **Sample Size 計算** で必要な要素として **誤っているもの** を選びなさい。", choices: ["α(第 1 種誤り)", "β(第 2 種誤り)", "MDE(最小検出効果)", "GPU 個数"], correctIndex: 3, explanation: "**Sample Size**: $n \\approx \\sigma^2 (z_{\\alpha/2} + z_\\beta)^2 / MDE^2$。**α=0.05 / β=0.2 / MDE 業務的に合意**が標準。**A/B Test 計画段階で必ず計算**(後付けは p-hacking リスク)。" },
  { id: "dsl-q76", category: "因果推論", difficulty: 2, question: "**RCT(Randomized Controlled Trial)** が **観察データ** より優れる点として最も適切なものを選びなさい。", choices: ["処置と結果の交絡を **無作為割付** で原理的に解消", "サンプル数大", "GPU 速度", "コスト最小"], correctIndex: 0, explanation: "**RCT**: 治療群 / 対照群を無作為割付 → 交絡変数の影響を期待的に均等化 → 因果効果の不偏推定。**医療 / 経済学 / オンライン A/B テスト** が代表。コストは高い。" },
  { id: "dsl-q77", category: "Data Quality", difficulty: 2, question: "**データ品質の 6 次元** として **誤っているもの** を選びなさい。", choices: ["正確性 / 完全性 / 一貫性", "適時性 / 一意性 / 有効性", "Provenance / Lineage", "GPU 利用率"], correctIndex: 3, explanation: "**Data Quality 6 D**(DAMA): Accuracy / Completeness / Consistency / Timeliness / Uniqueness / Validity。**Lineage / Provenance** で追跡可能化。GPU は無関係。" },
  { id: "dsl-q78", category: "Storytelling", difficulty: 2, question: "**Data Storytelling** の基本構造として最も適切なものを選びなさい。", choices: ["Setup(背景)→ Conflict(課題)→ Resolution(発見と提言)", "数値羅列のみ", "GUI 設計", "GPU 利用"], correctIndex: 0, explanation: "**Data Storytelling**(Cole Knaflic): 物語構造で説得力。**Audience-Centered / Data + Visual + Narrative / Single Big Idea**。Insight だけでなく Action につなげるのが目的。" },
  { id: "dsl-q79", category: "Skills", difficulty: 2, question: "**データサイエンティスト協会(JDSC)** が定義する **DS スキルの 3 領域** として最も適切なものを選びなさい。", choices: ["ビジネス力 / データサイエンス力 / データエンジニアリング力", "Python / R / SQL", "Cloud / On-prem / Hybrid", "GUI / API / DB"], correctIndex: 0, explanation: "**JDSC 3 領域**(2014 提唱): ビジネス力(課題把握 ・ 提案)・ DS 力(統計 ・ ML)・ DE 力(基盤 ・ コード)。**スキルチェックリスト**(2024 ver4)で各領域のレベル定義。DS 検定の中核 FW。" },
  { id: "dsl-q80", category: "実務", difficulty: 2, question: "**DS 検定リテラシー** で重視される **教養レベル能力** として最も適切なものを選びなさい。", choices: ["統計基礎 + ML 概要 + 倫理 + 業務適用判断 + 結果解釈の総合教養", "ML 実装のみ", "GUI 操作のみ", "数学のみ"], correctIndex: 0, explanation: "**DS リテラシー試験範囲**: ① 数理統計 ・ ML の基本 ② DS の業務応用 ③ AI 倫理 ・ Privacy ・ 法令 ④ データ駆動意思決定の理解。**社会人教養レベル**の DS リテラシ判定。" },
];
