...
blogPosts.push({
  slug: "grade-2-last-month-study-plan",
  title: "統計検定2級 直前1ヶ月で40点上げる勉強法",
  description:
    "統計検定2級まで残り1ヶ月。基礎が固まりきっていない人向けに、1日1〜2時間で合格点を狙う逆算プランを公開。週ごとのチェックポイントと、捨て論点の選び方まで具体的に解説。",
  publishedAt: "2026-05-03",
  category: "学習法",
  tldr: [
    "1ヶ月で40点上げるなら『推定・検定・回帰』の3本柱に絞る",
    "週1〜2は本番形式の模試で時間配分を体に入れる",
    "捨てて良い論点(時系列・実験計画の応用部分など)を明確化",
    "間違えた問題は SRS に乗せて翌日・3日後・1週間後に復習",
  ],
  body: [
    {
      type: "p",
      text: "「過去問を解いてみたら 40 点だった」── 試験 1 ヶ月前にこの状況になった受験者は多いはずです。本記事では、平日 1〜2 時間・週末 3〜4 時間の予算で**合格ライン(60 点)に届かせるための逆算プラン**を提示します。",
    },
    { type: "h3", text: "前提:統計検定2級の合格ライン" },
    {
      type: "list",
      style: "bullet",
      items: [
        "**合格基準**: 60 点以上(100 点満点)、近年は CBT で受験者ごとに問題が変動",
        "**問題構成**: 全 35 問前後、推定・検定・回帰・確率分布が中心(各 20% 前後)",
        "**所要時間**: 90 分。1 問あたり 2.5 分、見直しに 5 分残すと理想",
      ],
    },
    { type: "h3", text: "戦略の核 ─ 高頻出 3 領域に絞る" },
    {
      type: "intuition",
      title: "「全部やろうとしない」が最重要",
      body: "1 ヶ月で全範囲を網羅するのは不可能。**推定・検定・回帰** の 3 本柱だけで合格点に届く問題構成になっており、これらに 70% の時間を投入すれば 60 点ラインは現実的です。",
    },
    {
      type: "list",
      style: "number",
      items: [
        "**推定(信頼区間・標準誤差・点推定の性質)** ─ 出題数 8〜10 問",
        "**検定(z・t・カイ二乗・F の使い分け、p 値の解釈)** ─ 出題数 10〜12 問",
        "**回帰分析(単回帰・重回帰の係数解釈、決定係数)** ─ 出題数 4〜6 問",
      ],
    },
    { type: "h3", text: "週別プラン" },
    {
      type: "ex",
      title: "週 1 ─ 推定・検定の基礎を完璧に",
      body: "**月〜金(各 1〜1.5 時間)**\n- z 分布 / t 分布 / カイ二乗 / F の各表の見方を徹底\n- 信頼区間の式(母平均・母比率・母分散)を 5 つ暗記\n- [/textbook/grade-2#ch1](/textbook/grade-2#ch1) と [/textbook/grade-2#ch2](/textbook/grade-2#ch2) を読み込み\n\n**土・日(各 3〜4 時間)**\n- [/quiz/grade-2](/quiz/grade-2) で推定・検定カテゴリの問題を全部解く\n- 間違えた問題は復習リストへ自動登録",
    },
    {
      type: "ex",
      title: "週 2 ─ 回帰分析と分散分析",
      body: "**月〜金**\n- 単回帰: 最小二乗法の式・決定係数の意味・残差プロットの読み方\n- 重回帰: 偏回帰係数の意味・自由度調整済み R²・多重共線性\n- 一元配置 ANOVA: F 比の計算\n- [/textbook/grade-2#ch3](/textbook/grade-2#ch3) と [/textbook/grade-2#ch4](/textbook/grade-2#ch4)\n\n**土・日**\n- 過去問形式の模試 1 本: [/mock/grade-2](/mock/grade-2)\n- 結果分析: どのカテゴリで何問落としたかを記録",
    },
    {
      type: "ex",
      title: "週 3 ─ 苦手潰し + 計算問題対応",
      body: "**月〜金**\n- 復習ページ [/review](/review) で SRS が今日期限の問題を全消化\n- 計算問題対策: [/tools](/tools) の信頼区間・p 値・サンプルサイズ計算機で『手で電卓を叩く感覚』を養う\n- 間違いノート(または本サイトのブックマーク + メモ機能)を整理\n\n**土・日**\n- 模試 2 本目で時間配分を計測\n- 90 分以内に終わるか? 解けない問題を飛ばす判断は早めに",
    },
    {
      type: "ex",
      title: "週 4 ─ 仕上げ + 暗記",
      body: "**月〜金**\n- [/flashcards](/flashcards) で 2 級級用語 80 語を完全暗記\n- [/cheatsheet](/cheatsheet) を毎朝眺めて公式を頭に焼き付ける\n- 模試 3 本目で 60 点超えを確認\n\n**土・日**\n- 直前 24 時間: 軽く流すのみ。新規論点に手を出さない\n- 試験当日: コーヒー飲んで会場へ",
    },
    { type: "h3", text: "捨てて良い論点(優先度低)" },
    {
      type: "list",
      style: "bullet",
      items: [
        "**時系列の細かい計算**(MA・AR の手計算は出題比率低)",
        "**実験計画法の細部**(乱塊法・ラテン方格はほぼ出ない)",
        "**ノンパラメトリック**(出題されても 1 問。捨てて推定・検定強化に回す方が得点期待値高)",
        "**確率分布の暗記公式すべて**(超幾何・負の二項などは正規・二項・ポアソンに比べると優先度低)",
      ],
    },
    { type: "h3", text: "つまずきがちな『落とし穴』 5 選" },
    {
      type: "list",
      style: "number",
      items: [
        "**標本分散と不偏分散の違い**: 検定問題では n-1 で割る不偏分散がほとんど",
        "**両側 vs 片側検定**: 問題文の『〜と異なる』『〜より大きい』のキーワードに注意",
        "**z 検定 vs t 検定**: 母分散既知 → z、未知 → t。サンプルサイズだけで判断しない",
        "**信頼区間の解釈**: 『真値が区間に入る確率』ではなく『手続きの性質』",
        "**重回帰の係数**: 偏回帰係数 ≠ 単純相関(他の変数を固定したときの効果)",
      ],
    },
    { type: "h3", text: "本番当日のテクニック" },
    {
      type: "list",
      style: "bullet",
      items: [
        "**最初の 5 分**: 全問をざっと眺めて、得意な問題から手を付ける順序を決める",
        "**1 問 3 分ルール**: 3 分以上悩む問題は飛ばしてマーク、後で戻る",
        "**計算ミスの自分検出**: 計算結果が選択肢と全く違うときは式を疑う",
        "**最後の 10 分**: 飛ばした問題に再挑戦 + マークシートの見直し",
      ],
    },
    { type: "h3", text: "学習を継続させる仕組み" },
    {
      type: "p",
      text: "1 ヶ月の学習を続けるには『毎日のリズム』が鍵。本サイトでは:",
    },
    {
      type: "list",
      style: "bullet",
      items: [
        "[**今日の 1 問**](/) ─ ホームに毎日 1 問。続けるとストリークがつく",
        "[**SRS 復習リスト**](/review) ─ 間違えた問題が自動的に復習日に再出題",
        "[**学習プラン計算機**](/plan) ─ 試験日入力で残り日数とペースを表示",
        "[**ブックマーク + メモ**](/bookmarks) ─ 苦手問題に自分用メモ",
      ],
    },
    { type: "h3", text: "まとめ ─ 1 ヶ月で 40 点 → 60 点へ" },
    {
      type: "list",
      style: "bullet",
      items: [
        "**3 本柱に絞る**: 推定・検定・回帰",
        "**週末は必ず模試**: 時間配分を体に入れる",
        "**復習は SRS 任せ**: 自動スケジュールで効率最大化",
        "**捨てる勇気**: 全範囲完璧は無理。優先度の高い領域に集中",
      ],
    },
    { type: "h3", text: "関連リンク" },
    {
      ...
      style: "bullet",
      items: [
        "[**統計検定2級 教科書**](/textbook/grade-2) ─ 全 4 章 13 セクション",
        "[**統計検定2級 演習問題**](/quiz/grade-2) ─ 45 問",
        "[**統計検定2級 模試**](/mock/grade-2) ─ 本番形式",
        "[**統計計算ツール**](/tools) ─ 計算問題の自分採点に",
        "[**暗記カード**](/flashcards) ─ 重要用語の最終チェック",
      ],
    },
  ],
});
...
blogPosts.push({
  slug: "g-test-2026-generative-ai",
  title: "2026年版 G検定で生成AIはどう問われるか ─ 出題予想と対策",
  description:
    "2024年11月のG検定シラバス改訂で生成AI関連が大幅追加。2026年試験では具体的にどんな出題が予想されるか、対策キーワード一覧と頻出パターンを徹底解説。",
  publishedAt: "2026-05-03",
  category: "G検定対策",
  tldr: [
    "2024年改訂以降、G検定の生成AI出題は『キーワード選択型』が中心",
    "頻出: RAG・Chain-of-Thought・LoRA・RLHF・EU AI Act",
    "AI 規制(EU AI Act 4 段階)・著作権法 30 条の 4 が新規追加",
    "歴史問題(ENIAC・ダートマス会議など)の比重は縮小",
  ],
  body: [
    {
      type: "p",
      text: "G検定は 2024 年 11 月のシラバス改訂以降、**生成 AI(LLM・拡散モデル)関連のキーワードが大幅追加** されました。2026 年現在の試験では、AI の歴史よりも『現代の実装・運用・規制』の比重が高くなっています。本記事では具体的に何が問われるかを整理します。",
    },
    { type: "h3", text: "シラバス改訂の大きな流れ" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "頻出キーワード(2026 年版)" },
    { type: "h4", text: "1. 生成 AI の基礎概念" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h4", text: "3. AI 倫理・規制(2026 で重要度急増)" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h4", text: "4. AI システム運用(MLOps)" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "出題パターン例" },
    {
      type: "ex",
      title: "パターン1: キーワード選択",
      body: "「次のうち、LLM の出力にもっともらしい嘘が含まれる現象を指す用語はどれか?」\n→ 答え: **ハルシネーション**\n\nこのタイプは語句の意味を知っていれば即答できます。",
    },
    {
      type: "ex",
      title: "パターン2: 概念の比較",
      body: "「Chain-of-Thought と RAG の違いとして最も適切な記述はどれか?」\n→ 答え: CoT は推論過程を明示する手法、RAG は外部知識を取り込む手法\n\n**用語ペアでの違いを問う問題**は近年増加。本サイトの[用語集](/glossary)で隣接用語を比較しながら覚えると効果的。",
    },
    {
      type: "ex",
      title: "パターン3: 規制の理解",
      body: "「EU AI 法でリスク区分に該当しないものはどれか?」\n→ 答え: 『中リスク』(EU AI 法は『許容できない / 高 / 限定 / 最小』の 4 段階)\n\n**法律名 + 数字** の組み合わせは記憶必須。",
    },
    {
      type: "ex",
      title: "パターン4: 実装技術の特徴",
      body: "「LoRA の主な利点として最も適切なものは?」\n→ 答え: 元のモデルを凍結したまま低ランク行列だけを学習し、VRAM とディスクを大幅に節約\n\n**実装上のメリット** を理解しているかが問われます。",
    },
    { type: "h3", text: "対策の進め方" },
    {
      type: "list",
    ...
    { type: "h3", text: "捨てて良い論点(2026 では優先度低)" },
    {
      type: "list",
      style: "bullet",
      items: [
...
blogPosts.push({
  slug: "multicollinearity-vif-explained",
  title: "重回帰分析の多重共線性 ─ VIF で診断・解決する方法",
  description:
  ...
  tldr: [
    ...
    "症状: 係数の標準誤差が膨張、係数の符号が直感と逆",
    "診断: VIF が 5〜10 を超えたら危険信号",
    "解決: 変数削除・主成分分析・リッジ回帰",
  ],
  body: [
    {
      type: "p",
      text: "重回帰分析を実行したら『個々の係数は有意でないのに F 検定全体は有意』『身長が増えると体重が **減る** という直感に反する係数』── こんな結果に出会ったことはありませんか? 原因の多くは **多重共線性(multicollinearity)** です。本記事では現象の本質、VIF による診断、解決方法を順に解説します。",
    },
    { type: "h3", text: "多重共線性とは" },
    {
      type: "def",
      title: "定義",
      body: "重回帰モデル $y = \\beta_0 + \\beta_1 x_1 + \\cdots + \\beta_k x_k + \\varepsilon$ で、**説明変数同士に強い線形相関がある** 状態を多重共線性と呼ぶ。極端な場合(完全多重共線性)は $X^\\top X$ が特異になり、$\\hat{\\beta} = (X^\\top X)^{-1} X^\\top y$ が計算不能になる。",
    },
    { type: "h3", text: "なぜ問題になるのか ─ 直感的説明" },
    {
      type: "intuition",
      title: "「身長」と「座高」が同じモデルにあると…",
      body: "身長と座高はほぼ同じ情報を持っています。両方をモデルに入れると、モデルは『どちらが体重を予測するか』を区別できず、係数が不安定になります。同じデータでサンプルを少し変えただけで、$\\hat{\\beta}_1$ が +5 → -3 のように暴れる現象が起きます。",
    },
    { type: "h3", text: "症状チェックリスト" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "VIF(分散拡大係数)による診断" },
    {
      type: "def",
      title: "VIF (Variance Inflation Factor)",
      body: "$$\\mathrm{VIF}_j = \\frac{1}{1 - R_j^2}$$\n\n$R_j^2$ は **他の説明変数だけで $x_j$ を回帰したときの決定係数**。$x_j$ が他変数で完全に予測できるなら $R_j^2 = 1$ で VIF は無限大、独立なら $R_j^2 = 0$ で VIF = 1。",
    },
    {
      type: "ex",
      title: "VIF の判定基準(慣例)",
    ...
    { type: "h3", text: "Python での実装" },
    {
      type: "code",
      title: "statsmodels で VIF を計算",
      runnable: true,
      python: "import numpy as np\nimport statsmodels.api as sm\nfrom statsmodels.stats.outliers_influence import variance_inflation_factor\n\nrng = np.random.default_rng(42)\nn = 200\n\n# 多重共線性を意図的に作る: x1 と x2 はほぼ同じ\nx1 = rng.normal(0, 1, n)\nx2 = x1 + rng.normal(0, 0.1, n)  # x1 とほぼ等しい\nx3 = rng.normal(0, 1, n)         # 独立\ny = 2 * x1 + 1 * x3 + rng.normal(0, 0.5, n)\n\nX = sm.add_constant(np.column_stack([x1, x2, x3]))\nmodel = sm.OLS(y, X).fit()\nprint(model.summary())\n\nprint('\\n=== VIF ===')\nfor j, name in zip(range(1, X.shape[1]), ['x1', 'x2', 'x3']):\n    vif = variance_inflation_factor(X, j)\n    print(f'{name}: VIF = {vif:.2f}')\n# 期待出力: x1, x2 の VIF は 50+、x3 は 1〜2 程度",
    },
    { type: "h3", text: "解決方法 ─ 4 つのアプローチ" },
    { type: "h4", text: "1. 変数を削減する" },
    {
      type: "p",
      text: "最もシンプル。VIF が高い変数のうち、**ドメイン的に意味的に重複している方** を削除します。例: 身長と座高なら身長を残す、年収と年間支出なら年収を残す。",
    },
    { type: "h4", text: "2. 変数を統合する" },
    {
      type: "p",
      text: "相関する変数を **合成変数** にまとめる。例: 「数学スコア + 物理スコア」を「理系総合スコア」に。意味が説明可能なら最も解釈しやすい解決策。",
    },
    { type: "h4", text: "3. 主成分分析(PCA)で次元圧縮" },
    {
      type: "p",
      text: "説明変数を直交化(無相関化)した主成分スコアで回帰する。多重共線性は完全に解消されますが、**係数の解釈性は失われる** ため、予測重視の場面で。",
    },
    { type: "h4", text: "4. リッジ回帰(L2 正則化)" },
    {
      type: "p",
      text: "$\\hat{\\beta} = (X^\\top X + \\lambda I)^{-1} X^\\top y$ で、$\\lambda I$ を加えることで $X^\\top X$ の特異性を回避。バイアスは増えるが分散が大幅に減り、予測精度が向上する場合が多い。Lasso(L1)も類似。",
    },
    { type: "h3", text: "統計検定 2 級での出題傾向" },
    {
      type: "list",
      style: "bullet",
      items: [
        "**多重共線性の症状を選ばせる問題**(『個別 t 値が小さいのに F 検定で全体有意』を選ぶ)",
        "**VIF の式と判定基準**: $1/(1 - R_j^2)$",
        "**対処法を選ばせる問題**: 変数削減・PCA",
    ...
    { type: "h3", text: "実務での教訓" },
    {
      type: "intuition",
      title: "前処理段階で気付こう",
      body: "回帰モデルを fit する **前** に、説明変数の相関行列(`df.corr()`)を必ず確認する習慣を。|r| > 0.8 のペアがあれば、回帰前に統合・削除を検討しましょう。Kaggle・社内データ分析でも同じです。",
    },
    { type: "h3", text: "まとめ" },
    {
      type: "list",
...
blogPosts.push({
  slug: "toukei-2kyu-study-schedule-2026",
  title: "統計検定2級 学習スケジュール 2026年版 ─ 独学で合格する月別プラン",
  description:
    "統計検定2級に独学で合格するための学習スケジュールを2026年版として公開。必要時間60〜120時間、月別の進め方、章ごとの重み、おすすめ教材、CBT受験の戦略まで具体的に解説。",
  publishedAt: "2026-05-05",
  category: "学習法",
  tldr: [
    "統計検定2級の独学に必要な時間は数学背景により60〜120時間",
    "3ヶ月計画なら『推定検定2ヶ月+回帰分散1ヶ月』が王道",
    "公式テキスト1冊+過去問3年分+模試2回が最小構成",
    "CBT は受験予約の柔軟性を活かして自分のピーク日に当てる",
    "学習計画は[/plan](/plan)で残り日数から自動算出可能",
  ],
  body: [
    {
      type: "p",
      text: "**統計検定2級**は社会人・大学生に最も人気のある統計資格です。データサイエンス入門・公務員試験対策・大学院入試準備など多目的に使え、合格率は近年 **40〜45%** で推移しています。本記事では2026年に2級を狙う方に向けて、**独学で合格点(60点以上)を取るための月別スケジュール**を公開します。",
    },
    { type: "h3", text: "統計検定2級とは ─ 試験の基本情報" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "必要な学習時間の目安" },
    {
      type: "intuition",
      title: "数学の素養で時間が大きく変わる",
      body: "統計検定2級の必要時間は受験者の数学背景によって2倍ほど差が出ます。**理系学部出身で確率・統計を履修済み**なら 60時間前後、**文系・数学から離れて久しい**なら 120時間程度が現実的です。線形代数(行列・ベクトル)と微積分(偏微分)の基礎が固まっていない場合、+20時間ほど追加の準備時間を見ておきましょう。",
    },
    { type: "h3", text: "出題範囲と重み(2026年版)" },
    {
      type: "list",
      style: "number",
      items: [
    ...
    {
      type: "p",
      text: "上記の比率は近年の出題傾向に基づく目安です。**推定+検定で全体の55%** を占めるため、ここを最初に固めるのがセオリー。",
    },
    { type: "h3", text: "3ヶ月スケジュール ─ 標準プラン" },
    { type: "h4", text: "1ヶ月目: 基礎固め(週10〜15時間)" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h4", text: "2ヶ月目: 検定の徹底(週10〜15時間)" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h4", text: "3ヶ月目: 回帰・分散分析と仕上げ(週12〜18時間)" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "短期間で詰める場合 ─ 1ヶ月プラン" },
    {
      type: "p",
      text: "数学に自信があり、すでに大学で確率統計を履修済みの方向けの短期集中プラン。1日あたり2〜3時間の確保が必要です。",
    },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "CBT受験の戦略" },
    {
      type: "intuition",
      title: "CBTは『日付の柔軟性』が最大の武器",
      body: "従来の年2回ペーパー試験と違い、CBTなら **自分の調子のピークに合わせて受験日を決められます**。模試で安定して70点以上を取れるようになってから予約しても遅くありません。逆に予約日を先に決めて『その日に間に合わせる』戦略も有効です。",
    },
    {
      type: "list",
      style: "bullet",
...
blogPosts.push({
  slug: "g-test-vs-e-shikaku-comparison",
  title: "G検定 vs E資格 ─ 2026年版 どちらから受けるべきか目的別判定",
  description:
    "AI系資格の二大巨頭 G検定とE資格を徹底比較。試験概要・難易度・費用・対策方法・取得後のキャリアまで2026年版の最新情報で整理。AI転職・データサイエンス実務・副業の目的別にどちらから受けるべきか判定フローを提示。",
  publishedAt: "2026-05-05",
  category: "比較",
  tldr: [
    "G検定はビジネス向け『AIリテラシー』の証明、E資格はエンジニア向け『実装能力』の証明",
    "費用は G検定 13,200円 / E資格 33,000円(JDLA会員割引あり)",
    "難易度は E資格 >> G検定。学習時間は G検定 30〜50h / E資格 200〜300h",
    "AI業界転職は G検定先行、ML実装志向は E資格直行が効率的",
    "副業・社内で『AI担当』と名乗るならG検定で十分なケースが多い",
  ],
  body: [
    {
      type: "p",
      text: "**G検定**と**E資格**は日本ディープラーニング協会(JDLA)が運営するAI系資格の二枚看板です。名前は似ていますが、想定する受験者層・出題内容・難易度・取得後のキャリアまで大きく異なります。本記事では2026年最新情報で両者を徹底比較し、**自分の目的に応じてどちらから受けるべきか**を判断できるようにします。",
    },
    { type: "h3", text: "ひと目でわかる比較表" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "難易度の本当の差" },
    {
      type: "intuition",
      title: "E資格は『実装の試験』、G検定は『知識の試験』",
      body: "G検定は **キーワード理解** が中心で、用語集を反復すれば合格圏に届きます。一方 E資格は **コードを書く・数式を変形する・モデルの挙動を予測する** といった実装レベルの理解が要求されます。学習時間で表すと G検定が30〜50時間に対し、E資格は200〜300時間+認定講座の20〜80時間と一桁違います。",
    },
    { type: "h3", text: "費用の総額比較" },
    {
      type: "list",
      style: "bullet",
      items: [
        ...
        "**会社負担で受けられる**ケースも多いので、まずは社内制度を確認",
      ],
    },
    { type: "h3", text: "対策方法の違い" },
    { type: "h4", text: "G検定の対策" },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "取得後のキャリア比較" },
    { type: "h4", text: "G検定が活きる場面" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "目的別判定フロー" },
    {
      type: "ex",
      title: "目的1: AI業界に未経験から転職したい",
      body: "→ **G検定 → 実務経験 → E資格** の順がおすすめ。\n\nまずG検定で『AIに関心があり基礎知識がある』ことを示し、未経験OKのジュニアポジションに応募。実務でPython・MLを扱いながら半年〜1年でE資格に挑戦すれば、認定講座の費用を会社が出してくれるケースも多い。いきなりE資格は学習負担が大きく挫折しやすい。",
    },
    {
      type: "ex",
      title: "目的2: データサイエンス実務で即戦力になりたい",
      body: "→ **E資格に直行**(統計検定2級と並行)。\n\nすでにエンジニア経験があり、ML実装スキルを伸ばしたい人はE資格が最短ルート。G検定は半日で読める内容のため後回しでOK。E資格の学習は実務知識として直接活きる。",
    },
    {
      type: "ex",
      title: "目的3: 副業・社内でAI担当になりたい",
      body: "→ **G検定だけで十分** なケースが多い。\n\n副業案件・社内のAI担当業務では『AIリテラシーの証明』があれば足り、E資格レベルの実装力は要求されないことが多い。費用対効果でG検定が圧倒的に有利。E資格は『AI実装で稼ぐ』段階になってから検討。",
    },
    { type: "h3", text: "両資格の組み合わせ ─ 統計検定との連携" },
    {
      type: "p",
      text: "AIエンジニアを目指すなら、**G検定 → 統計検定2級 → E資格** の順序が最も学習効率が良いとされます。統計検定2級で確率・統計の数理基盤を固めることで、E資格の確率モデル・誤差逆伝播・最適化理論の理解が劇的にスムーズになります。",
    },
    { type: "h3", text: "よくある質問" },
    {
      type: "list",
...
blogPosts.push({
  slug: "toukei-textbooks-by-level-2026",
  title: "統計検定 おすすめ参考書 級別まとめ 2026年版 ─ 4級から1級まで",
  description:
    "統計検定の参考書を4級・3級・2級・準1級・1級の級別に整理。最初の1冊・問題演習・理論補強の3軸で2026年版のおすすめを比較。独学派と講座派の選び方、コスパ最強の組み合わせも提示。",
  publishedAt: "2026-05-05",
  category: "参考書",
  tldr: [
    "級別に『最初の1冊』『問題演習用』『理論補強』の3軸で選ぶ",
    "公式テキスト+公式問題集が基本、補助参考書は1〜2冊で十分",
    "準1級以上は『現代数理統計学の基礎』『統計学のための数学入門30講』が定番",
    "独学派は東京図書の公式系、講座派は AVILEN/データミックス を併用",
    "電子書籍版があれば検索性で大きく有利",
  ],
  body: [
    {
      type: "p",
      text: "**統計検定**は4級から1級・準1級まで7階級ある国家資格級の検定試験です。級ごとに必要な参考書が違い、特に2級から準1級への壁では数学のレベルが一段上がります。本記事では2026年現在で**実際に書店で買える教材**を級別にまとめ、目的に応じた選び方を提示します。",
    },
    { type: "h3", text: "選び方の基本3軸" },
    {
      type: "list",
      style: "number",
      items: [
    ...
    },
    {
      type: "intuition",
      title: "1冊主義より2冊組み合わせ",
      body: "1冊だけで完結する教材はほぼありません。**メイン1冊 + 問題集1冊** の最低2冊構成が標準。理論補強は **苦手分野が明確になってから** 追加で買う方がコスパ良し。最初から3冊揃えると挫折確率が上がります。",
    },
    { type: "h3", text: "統計検定4級 ─ 中学生レベルの基礎統計" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "統計検定3級 ─ 高校レベルの記述統計+確率" },
    { type: "h4", text: "最初の1冊" },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "統計検定2級 ─ 大学基礎レベルの推測統計" },
    {
      type: "p",
      text: "最も人気のある2級では、**推定・検定・回帰** が中心になります。詳細は[/textbook/grade-2](/textbook/grade-2)も併読してください。",
    },
    { type: "h4", text: "最初の1冊" },
    {
      type: "list",
    ...
    { type: "h3", text: "統計検定 準1級 ─ 多変量・実験計画・ベイズ" },
    {
      type: "intuition",
      title: "準1級は範囲が広い『総合格闘技』",
      body: "準1級は2級の知識を前提に、多変量解析・時系列・ベイズ・機械学習基礎まで一気に範囲が拡大します。1冊で全範囲をカバーする教材は実質1冊しかなく、**統計学実践ワークブック** が事実上のメインテキストです。",
    },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "統計検定1級 ─ 大学院修士レベルの数理統計" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "統計検定 データサイエンス系" },
    {
      type: "p",
      text: "2021年以降に追加された **DS基礎・DS発展・DSエキスパート** の3階級は、Pythonでの実装が問われます。",
    },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "独学派 vs 講座派 ─ 選び方" },
    { type: "h4", text: "独学が向いている人" },
    {
      type: "list",
      style: "bullet",
      items: [
...
blogPosts.push({
  slug: "python-stats-libraries-comparison",
  title: "Pythonで学ぶ統計学 ─ ライブラリ別 早わかり比較 2026年版",
  description:
  ...
  category: "実装",
  tldr: [
    "numpy=数値配列、scipy.stats=検定と分布、statsmodels=回帰の解釈、pandas=表データ、scikit-learn=ML",
    "統計検定の問題は scipy.stats と statsmodels で7割再現可能",
    "学術論文ベースの分析は statsmodels、ML予測重視は scikit-learn",
    "Pandas は前処理担当、計算は numpy / scipy に投げるのが速い",
    "迷ったら『目的が p値?係数?予測?』で決める",
  ],
  body: [
    {
      type: "p",
      text: "Pythonで統計分析を始めようとすると、**numpy・scipy・statsmodels・pandas・scikit-learn** といった似たような名前のライブラリが並び、どれを使うべきか迷います。本記事では2026年現在で標準的に使われる5大ライブラリを **用途別に整理** し、検定・推定・回帰・分類のそれぞれでどれを選ぶべきか実装例とともに解説します。",
    },
    { type: "h3", text: "5大ライブラリの役割" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "1. scipy.stats ─ 検定と確率分布" },
    {
      type: "p",
      text: "**scipy.stats** は統計検定の問題を Python で再現するときの第一選択。t検定・カイ二乗検定・正規性検定など主要な検定をワンライナーで実行できます。",
    },
    {
      type: "code",
      title: "scipy.stats: t検定とカイ二乗検定",
    ...
    { type: "h4", text: "scipy.stats が得意なこと" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "2. statsmodels ─ 回帰と時系列の解釈" },
    {
      type: "p",
      text: "**statsmodels** は回帰モデルの **解釈** に強い。係数・標準誤差・t値・p値・信頼区間が summary() でまとめて出力されます。学術論文・ビジネスレポートで使うならこちら。",
    },
    {
      type: "code",
      title: "statsmodels: OLS重回帰",
      python: "import numpy as np\nimport pandas as pd\nimport statsmodels.api as sm\n\nrng = np.random.default_rng(0)\nn = 200\ndf = pd.DataFrame({\n    'x1': rng.normal(0, 1, n),\n    'x2': rng.normal(0, 1, n),\n})\ndf['y'] = 2.0 * df['x1'] - 1.5 * df['x2'] + rng.normal(0, 0.5, n)\n\n# 切片を追加\nX = sm.add_constant(df[['x1', 'x2']])\nmodel = sm.OLS(df['y'], X).fit()\nprint(model.summary())\n\n# AIC・BIC・決定係数\nprint(f'R^2 = {model.rsquared:.3f}')\nprint(f'AIC = {model.aic:.2f}')",
    },
    { type: "h4", text: "statsmodels が得意なこと" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "3. scikit-learn ─ 機械学習の予測重視" },
    {
      type: "p",
      text: "**scikit-learn** は **予測精度** を最大化するためのライブラリ。係数解釈より train/test の評価指標を重視し、クロスバリデーションやハイパーパラメータ調整が標準装備されています。",
    },
    {
      type: "code",
      title: "scikit-learn: ロジスティック回帰と分類",
    ...
    { type: "h4", text: "scikit-learn が得意なこと" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "4. pandas ─ 表データの前処理王者" },
    {
      type: "p",
      text: "**pandas** は分析の **入口** です。データを読み込み・整形・集計するすべてを担当。最終的な数値計算は numpy / scipy / sklearn に投げるのがパフォーマンス上の常套手段。",
    },
    {
      type: "code",
      title: "pandas: 集計とグルーピング",
    ...
    { type: "h3", text: "5. numpy ─ すべての基盤" },
    {
      type: "p",
      text: "**numpy** は他のライブラリの基盤層。直接使う場面は『自前で数式を実装したい』『高速ベクトル演算が必要』といったシーンに限られますが、内部理解のために避けては通れません。",
    },
    {
      type: "code",
      title: "numpy: 信頼区間を手で計算",
    ...
    { type: "h3", text: "目的別の選び分けフロー" },
    {
      type: "ex",
      title: "シーン1: 統計検定の問題を再現したい",
      body: "→ **scipy.stats + numpy** が王道。t検定・カイ二乗検定・分布計算がすべて関数化されており、教科書の例題を1行で再現できます。\n\n回帰問題は **statsmodels** で summary() を表示すると、係数・p値・決定係数すべてが教科書の表と同じフォーマットで出力されます。",
    },
    {
      type: "ex",
      title: "シーン2: ビジネスでKPIを分析したい",
      body: "→ **pandas + statsmodels** の組み合わせ。pandas で前処理してから statsmodels の OLS で要因分析、係数を経営陣に見せる。**A/B テストの有意差判定** は scipy.stats.ttest_ind が簡単。",
    },
    {
      type: "ex",
      title: "シーン3: Kaggle・実務で予測モデルを作りたい",
      body: "→ **pandas + scikit-learn** が最強の組み合わせ。pandas で特徴量エンジニアリング、scikit-learn でモデル構築・評価。XGBoost / LightGBM / CatBoost を併用すると競技レベル。",
    },
    {
      type: "ex",
      title: "シーン4: 時系列予測がしたい",
      body: "→ **statsmodels(SARIMA・状態空間モデル)** か **prophet** を使う。短期はSARIMA、長期トレンド+季節性なら prophet が手軽。深層学習に行くなら PyTorch + 時系列専用ライブラリへ。",
    },
    { type: "h3", text: "学習順序の推奨" },
    {
      type: "list",
      style: "number",
      items: [
...
blogPosts.push({
  ...
  title: "AIエンジニアになるには 2026年版 ─ 必要なスキル・資格・ロードマップ",
  description:
    "AIエンジニアを目指す未経験者から経験者まで、2026年版の必要スキル・推奨資格・年収レンジ・1年学習ロードマップを完全網羅。数学・統計・Python・ML・MLOpsの順序立てた学習法と現実的なキャリアパスを提示。",
  publishedAt: "2026-05-05",
  category: "キャリア",
  tldr: [
    "未経験からAIエンジニアは1〜2年計画、経験者なら6ヶ月〜1年で到達可能",
    "必須スキル5本柱: 数学・統計・Python・機械学習・MLOps",
    "推奨資格は G検定→統計検定2級→E資格 の順",
    "年収レンジ: 未経験 400〜500万 / 中堅 600〜900万 / シニア 1000〜1800万",
    "学習はインプット3割・アウトプット7割、ポートフォリオ必須",
  ],
  body: [
    {
      type: "p",
      text: "**AIエンジニア**は2026年現在も最も需要が高い職種のひとつです。生成AI・LLMの普及で『AIを使える人材』への投資はさらに加速しており、エンジニア・データサイエンティストの転職市場は売り手優勢が続いています。本記事では未経験者と経験者それぞれに向けて、**必要なスキル・推奨資格・年収レンジ・1年学習ロードマップ** を2026年版の最新情報で整理します。",
    },
    { type: "h3", text: "AIエンジニアの定義と種類" },
    {
      type: "p",
      text: "『AIエンジニア』は曖昧な総称で、実際には以下のような職種に分かれます。",
    },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "必須スキル5本柱" },
    { type: "h4", text: "1. 数学(線形代数・微積分・確率統計)" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "推奨資格 ─ 取得順序" },
    {
      type: "intuition",
      title: "資格は『学習の道しるべ』として活用",
      body: "資格そのものより、**学習ロードマップとして使う** のが効果的。未経験者ほど資格取得を中間目標にすると挫折しにくく、面接でも学習過程を語れるようになります。",
    },
    { type: "h4", text: "推奨資格3点セット" },
    {
      type: "list",
      style: "number",
      items: [
    ...
    { type: "h3", text: "未経験者向け 1年ロードマップ" },
    { type: "h4", text: "1〜3ヶ月目: 数学とPython基礎" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h4", text: "10〜12ヶ月目: ポートフォリオと転職活動" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "経験者向け(エンジニア → AIエンジニア)6ヶ月プラン" },
    {
      type: "p",
      text: "すでにソフトウェアエンジニア経験がある場合、Python・Git・基本的な開発フローはスキップできるため、6ヶ月での転向が現実的です。",
    },
    {
      type: "list",
      style: "bullet",
    ...
    { type: "h3", text: "学習リソースの選び方" },
    { type: "h4", text: "オンラインコース" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "未経験から最初のジョブをつかむコツ" },
    {
      type: "list",
      style: "bullet",
      items: [
    ...
    { type: "h3", text: "まとめ ─ 2026年版のキャリア戦略" },
    {
      type: "list",
      style: "bullet",
      items: [
