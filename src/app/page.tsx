...
const HOME_DESCRIPTION =
  "AIエンジニアになるための統計・数学・Python を一気通貫で学べる無料サイト。演習問題 2,800+ 問・41 検定対応・40+ 教科書。数学基礎 → 統計学 → 機械学習 → AI 検定対策まで、4 ステップのロードマップで迷わず進めます。統計検定 4 級〜1 級・G 検定・E 資格・DS 検定にも完全対応。";
  ...
  return (
    <div>
      ...
      <section className="hero-band mb-16 md:mb-20 text-center px-6 py-14 md:py-20">
        ...
        >
          {[
            { label: "演習問題", value: "2,800+", emphasis: true },
            { label: "検定 ・ 級", value: "41" },
            { label: "教科書", value: "40+" },
            { label: "用語", value: "320+" },
            { label: "図解", value: "33" },
