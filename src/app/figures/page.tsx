...
const FIGURES: FigureEntry[] = [
  ...
  },
  {
    ...
    level: "準 1 級 / DS",
    category: "推測統計",
    insight: "原データから復元抽出を繰り返し、統計量の分布を経験的に得る。",
    link: "/blog/ai-stats-cheatsheet",
    linkLabel: "統計チートシートを読む",
  },
  {
    kind: "gbdt-tree",
    title: "GBDT の分割木",
    level: "DS / E 資格",
    category: "機械学習",
    insight: "残差を順次学習する弱学習器(浅い木)の集合。Kaggle 表データの定番。",
    link: "/blog/sklearn-introduction",
    linkLabel: "scikit-learn 入門ブログ",
  },
  {
    kind: "dropout",
    title: "Dropout",
    level: "E 資格",
    category: "DL",
    insight: "学習時にランダムにニューロンを脱落 → アンサンブル効果で過学習抑制。",
    link: "/certs/e-shikaku/textbook",
    linkLabel: "E 資格 教科書を読む",
  },
  {
    kind: "word2vec",
    title: "Word2Vec 埋め込み空間",
    level: "E 資格",
    category: "DL",
    insight: "意味的な関係がベクトルの方向として現れる(king − man + woman ≈ queen)。",
  ...
  },
  {
    ...
    level: "E 資格 / G 検定",
    category: "強化学習",
    insight: "人間の選好で報酬モデルを学習 → PPO で LLM を微調整する ChatGPT 系の核技術。",
    link: "/blog/llm-introduction",
    linkLabel: "LLM 入門ブログ",
  },
];
