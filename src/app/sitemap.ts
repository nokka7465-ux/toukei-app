...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticUrls: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/certs/ds-basic`, lastModified: now, changeFrequency: "yearly", priority: 0.6 },
    { url: `${SITE_URL}/certs/survey`, lastModified: now, changeFrequency: "yearly", priority: 0.6 },
