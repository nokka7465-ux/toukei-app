...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    label: "AWS 認定",
    items: [
      { href: "/certs/aws-ai-practitioner", label: "AWS AI Practitioner(AIF-C01)" },
      { href: "/certs/aws-saa", label: "AWS Solutions Architect Associate(SAA)" },
      { href: "/certs/aws-ml-engineer", label: "AWS ML Engineer Associate(MLA-C01)" },
  ...
  {
    label: "Azure / Microsoft 認定",
    items: [
      { href: "/certs/azure-ai-900", label: "Azure AI Fundamentals(AI-900)" },
      ...
      { href: "/certs/azure-az-305", label: "Azure Solutions Architect Expert(AZ-305)" },
      { href: "/certs/sc-100", label: "Microsoft Cybersecurity Architect Expert(SC-100)" },
  ...
  {
    label: "Lakehouse / BI / DWH",
    items: [
      { href: "/certs/snowflake-snowpro", label: "Snowflake SnowPro Core" },
      { href: "/certs/snowflake-dea", label: "SnowPro Advanced: Data Engineer(DEA)" },
      { href: "/certs/databricks-data-engineer", label: "Databricks Data Engineer Associate" },
      { href: "/certs/databricks-ml-engineer", label: "Databricks ML Engineer Professional" },
      { href: "/certs/tableau-specialist", label: "Tableau Desktop Specialist" },
      { href: "/certs/tableau-data-analyst", label: "Tableau Certified Data Analyst" },
    ],
  },
  {
